...
|-------|-------|------|-------|
| ![Girafarig](../assets/sprites/girafarig/front.gif "Girafarig: Its tail, which also contains a small brain, may bite on its own if it notices an alluring smell.") | ![Girafarig](../assets/sprites/girafarig/front_shiny.png "Girafarig: Its tail, which also contains a small brain, may bite on its own if it notices an alluring smell.") | ![Girafarig](../assets/sprites/girafarig/back.png "Girafarig: Its tail, which also contains a small brain, may bite on its own if it notices an alluring smell.") | ![Girafarig](../assets/sprites/girafarig/back_shiny.png "Girafarig: Its tail, which also contains a small brain, may bite on its own if it notices an alluring smell.") |

### Female Sprites

| Front | Shiny | Back | Shiny |
|-------|-------|------|-------|
| ![Girafarig](../assets/sprites/girafarig/front_female.gif "Girafarig: Its tail, which also contains a small brain, may bite on its own if it notices an alluring smell.") | ![Girafarig](../assets/sprites/girafarig/front_shiny_female.png "Girafarig: Its tail, which also contains a small brain, may bite on its own if it notices an alluring smell.") | ![Girafarig](../assets/sprites/girafarig/back_female.png "Girafarig: Its tail, which also contains a small brain, may bite on its own if it notices an alluring smell.") | ![Girafarig](../assets/sprites/girafarig/back_shiny_female.png "Girafarig: Its tail, which also contains a small brain, may bite on its own if it notices an alluring smell.") |
