...
**Sacred Gold:** Revived from an ancient fossil, this Pokémon uses air stored in its shell to sink and rise in water.

**Storm Silver:** This Pokémon from ancient times is said to have navigated the sea by adeptly twisting its 10 tentacles.
...
|-------|-------|------|-------|
| ![Omanyte](../assets/sprites/omanyte/front.gif "Omanyte: This Pokémon from ancient times is said to have navigated the sea by adeptly twisting its 10 tentacles.") | ![Omanyte](../assets/sprites/omanyte/front_shiny.png "Omanyte: This Pokémon from ancient times is said to have navigated the sea by adeptly twisting its 10 tentacles.") | ![Omanyte](../assets/sprites/omanyte/back.png "Omanyte: This Pokémon from ancient times is said to have navigated the sea by adeptly twisting its 10 tentacles.") | ![Omanyte](../assets/sprites/omanyte/back_shiny.png "Omanyte: This Pokémon from ancient times is said to have navigated the sea by adeptly twisting its 10 tentacles.") |
...
| 28 | <span class="tooltip" title="If the foe’s HP is down to about half, this attack will hit with double the power.">Brine</span> | ![water](../assets/types/water.png "Water"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 65 | 100 | 10 |
...
| <span class="tooltip" title="Traps the foe inside a whirlpool that lasts for two to five turns. The user can pass through whirlpools.">Whirlpool</span> | ![water](../assets/types/water.png "Water"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 35 | 85 | 15 |
