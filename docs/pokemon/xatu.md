...
| Front | Shiny | Back | Shiny |
|-------|-------|------|-------|
| ![Xatu](../assets/sprites/xatu/front_female.gif "Xatu: In South America, it is said that its right eye sees the future and its left eye views the past.") | ![Xatu](../assets/sprites/xatu/front_shiny_female.png "Xatu: In South America, it is said that its right eye sees the future and its left eye views the past.") | N/A | N/A |
...
|------------|---------|--------|--------|-----------|---------|
| #178 | ![psychic](../assets/types/psychic.png "Psychic"){: width="48"}<br>![flying](../assets/types/flying.png "Flying"){: width="48"} | 1.5 m /<br>4.9 ft | 15.0 kg /<br>33.1 lbs | 1. <span class="tooltip" title="Passes a burn, poison, or paralysis to the foe.">Synchronize</span><br>2. <span class="tooltip" title="The Pokémon awakens quickly from sleep.">Early Bird</span> | N/A |
