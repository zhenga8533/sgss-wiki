...
|-------|-------|------|-------|
| ![Buneary](../assets/sprites/buneary/front.gif "Buneary: You can tell how it feels by the way it rolls its ears. When it’s scared, both ears are rolled up.") | ![Buneary](../assets/sprites/buneary/front_shiny.png "Buneary: You can tell how it feels by the way it rolls its ears. When it’s scared, both ears are rolled up.") | ![Buneary](../assets/sprites/buneary/back.png "Buneary: You can tell how it feels by the way it rolls its ears. When it’s scared, both ears are rolled up.") | ![Buneary](../assets/sprites/buneary/back_shiny.png "Buneary: You can tell how it feels by the way it rolls its ears. When it’s scared, both ears are rolled up.") |
...
|------------|---------|--------|--------|-----------|---------|
| #427 | ![normal](../assets/types/normal.png "Normal"){: width="48"} | 0.4 m /<br>1.3 ft | 5.5 kg /<br>12.1 lbs | 1. <span class="tooltip" title="Enables sure getaway from wild Pokémon.">Run Away</span><br>2. <span class="tooltip" title="The Pokémon can’t use any held items.">Klutz</span><br>3. <span class="tooltip" title="The Pokémon is protected from paralysis.">Limber</span> | #67 |
...
|----------|------------|-----------------|-----------|-------------|------------|
| 1 Speed | 190 | 0 | 70 | Medium | <span class="tooltip" title="If held by a Pokémon, it weakens a foe’s supereffective Fighting-type attack.">Chople Berry</span> (5%) |
...
| 53 | <span class="tooltip" title="The user faints. In return, the Pokémon taking its place will have its HP restored and status cured.">Healing Wish</span> | ![psychic](../assets/types/psychic.png "Psychic"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 10 |
