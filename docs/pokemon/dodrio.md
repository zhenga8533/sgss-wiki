...
|-------|-------|------|-------|
| ![Dodrio](../assets/sprites/dodrio/front.gif "Dodrio: If one of the heads gets to eat, the others will be satisfied, too, and they will stop squabbling.") | ![Dodrio](../assets/sprites/dodrio/front_shiny.png "Dodrio: If one of the heads gets to eat, the others will be satisfied, too, and they will stop squabbling.") | ![Dodrio](../assets/sprites/dodrio/back.png "Dodrio: If one of the heads gets to eat, the others will be satisfied, too, and they will stop squabbling.") | ![Dodrio](../assets/sprites/dodrio/back_shiny.png "Dodrio: If one of the heads gets to eat, the others will be satisfied, too, and they will stop squabbling.") |

### Female Sprites

| Front | Shiny | Back | Shiny |
|-------|-------|------|-------|
| ![Dodrio](../assets/sprites/dodrio/front_female.gif "Dodrio: If one of the heads gets to eat, the others will be satisfied, too, and they will stop squabbling.") | ![Dodrio](../assets/sprites/dodrio/front_shiny_female.png "Dodrio: If one of the heads gets to eat, the others will be satisfied, too, and they will stop squabbling.") | ![Dodrio](../assets/sprites/dodrio/back_female.png "Dodrio: If one of the heads gets to eat, the others will be satisfied, too, and they will stop squabbling.") | ![Dodrio](../assets/sprites/dodrio/back_shiny_female.png "Dodrio: If one of the heads gets to eat, the others will be satisfied, too, and they will stop squabbling.") |
...
|------------|---------|--------|--------|-----------|---------|
| #85 | ![normal](../assets/types/normal.png "Normal"){: width="48"}<br>![flying](../assets/types/flying.png "Flying"){: width="48"} | 1.8 m /<br>5.9 ft | 85.2 kg /<br>187.8 lbs | 1. <span class="tooltip" title="Enables sure getaway from wild Pokémon.">Run Away</span><br>2. <span class="tooltip" title="The Pokémon awakens quickly from sleep.">Early Bird</span><br>3. <span class="tooltip" title="Raises evasion if the Pokémon is confused.">Tangled Feet</span> | N/A |
