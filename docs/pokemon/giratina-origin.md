...
|-------|-------|------|-------|
| ![Giratina Origin](../assets/sprites/giratina-origin/front.png "Giratina Origin: This Pokémon is said to live in a world on the reverse side of ours, where common knowledge is distorted and strange.") | ![Giratina Origin](../assets/sprites/giratina-origin/front_shiny.png "Giratina Origin: This Pokémon is said to live in a world on the reverse side of ours, where common knowledge is distorted and strange.") | ![Giratina Origin](../assets/sprites/giratina-origin/back.png "Giratina Origin: This Pokémon is said to live in a world on the reverse side of ours, where common knowledge is distorted and strange.") | ![Giratina Origin](../assets/sprites/giratina-origin/back_shiny.png "Giratina Origin: This Pokémon is said to live in a world on the reverse side of ours, where common knowledge is distorted and strange.") |
...
| 42 | <span class="tooltip" title="The user slashes with a sharp claw made from shadows. It has a high critical-hit ratio.">Shadow Claw</span> | ![ghost](../assets/types/ghost.png "Ghost"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 70 | 100 | 15 |
| 46 | <span class="tooltip" title="The user disappears, then strikes the foe on the second turn. It hits even if the foe protects itself.">Shadow Force</span> | ![ghost](../assets/types/ghost.png "Ghost"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 120 | 100 | 5 |
