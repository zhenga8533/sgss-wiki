...
|-------|-------|------|-------|
| ![Ampharos](../assets/sprites/ampharos/front.gif "Ampharos: The bright light on its tail can be seen far away. It has been treasured since ancient times as a beacon.") | ![Ampharos](../assets/sprites/ampharos/front_shiny.png "Ampharos: The bright light on its tail can be seen far away. It has been treasured since ancient times as a beacon.") | ![Ampharos](../assets/sprites/ampharos/back.png "Ampharos: The bright light on its tail can be seen far away. It has been treasured since ancient times as a beacon.") | ![Ampharos](../assets/sprites/ampharos/back_shiny.png "Ampharos: The bright light on its tail can be seen far away. It has been treasured since ancient times as a beacon.") |
...
|------------|---------|--------|--------|-----------|---------|
| #181 | ![electric](../assets/types/electric.png "Electric"){: width="48"} | 1.4 m /<br>4.6 ft | 61.5 kg /<br>135.6 lbs | 1. <span class="tooltip" title="Contact with the Pokémon may cause paralysis.">Static</span><br>2. <span class="tooltip" title="Ups Sp. Atk if another Pokémon has Minus.">Plus</span> | N/A |
...
| 25 | <span class="tooltip" title="The user boosts the power of the Electric move it uses next. It also raises the user’s Sp. Def stat.">Charge</span> | ![electric](../assets/types/electric.png "Electric"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 20 |
| 30 | <span class="tooltip" title="The foe is punched with an electrified fist. It may leave the target with paralysis.">Thunder Punch</span> | ![electric](../assets/types/electric.png "Electric"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 75 | 100 | 15 |
...
| 71 | <span class="tooltip" title="The user attacks with a ray of light that sparkles as if it were made of gemstones. ">Power Gem</span> | ![rock](../assets/types/rock.png "Rock"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 80 | 100 | 20 |
