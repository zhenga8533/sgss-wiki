...
|-------|-------|------|-------|
| ![Glalie](../assets/sprites/glalie/front.gif "Glalie: It can instantly freeze moisture in the atmosphere. It uses this power to freeze its foes.") | ![Glalie](../assets/sprites/glalie/front_shiny.png "Glalie: It can instantly freeze moisture in the atmosphere. It uses this power to freeze its foes.") | ![Glalie](../assets/sprites/glalie/back.png "Glalie: It can instantly freeze moisture in the atmosphere. It uses this power to freeze its foes.") | ![Glalie](../assets/sprites/glalie/back_shiny.png "Glalie: It can instantly freeze moisture in the atmosphere. It uses this power to freeze its foes.") |
...
|----------|------------|-----------------|-----------|-------------|------------|
| 2 None | 75 | 50 | 168 | Medium | <span class="tooltip" title="If held by a Pokémon, it weakens a foe’s supereffective Steel-type attack.">Babiri Berry</span> (5%) |
...
| 42 | <span class="tooltip" title="The user delivers a life-endangering attack at full power. The user also takes terrible damage.">Head Smash</span> | ![rock](../assets/types/rock.png "Rock"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 150 | 80 | 5 |
...
| 67 | <span class="tooltip" title="The user launches a huge boulder at the foe to attack. It must rest on the next turn, however.">Rock Wrecker</span> | ![rock](../assets/types/rock.png "Rock"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 150 | 90 | 5 |
