...
**Sacred Gold:** Its tongue has well-developed nerves that run to the very tip, so it can be deftly manipulated.

**Storm Silver:** Its long tongue, slathered with a gooey saliva, sticks to anything, so it is very useful.
...
|-------|-------|------|-------|
| ![Lickitung](../assets/sprites/lickitung/front.gif "Lickitung: Its long tongue, slathered with a gooey saliva, sticks to anything, so it is very useful.") | ![Lickitung](../assets/sprites/lickitung/front_shiny.png "Lickitung: Its long tongue, slathered with a gooey saliva, sticks to anything, so it is very useful.") | ![Lickitung](../assets/sprites/lickitung/back.png "Lickitung: Its long tongue, slathered with a gooey saliva, sticks to anything, so it is very useful.") | ![Lickitung](../assets/sprites/lickitung/back_shiny.png "Lickitung: Its long tongue, slathered with a gooey saliva, sticks to anything, so it is very useful.") |
...
| 37 | <span class="tooltip" title="The user tries to cut ahead of the foe to steal and use the foe’s intended move with greater power.">Me First</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 20 |
| 41 | <span class="tooltip" title="The user rests to cure itself of a poisoning, burn, or paralysis. ">Refresh</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 20 |
| 45 | <span class="tooltip" title="An earsplitting screech is emitted to sharply reduce the foe’s Defense stat. ">Screech</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 85 | 40 |
...
| 53 | <span class="tooltip" title="The user powerfully wrings the foe. The more HP the foe has, the greater this attack’s power.">Wring Out</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | — | 100 | 5 |
| 57 | <span class="tooltip" title="The user maximizes its Attack stat in exchange for HP equal to half its max HP.">Belly Drum</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 10 |
