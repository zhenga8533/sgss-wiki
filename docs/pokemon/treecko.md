...
|-------|-------|------|-------|
| ![Treecko](../assets/sprites/treecko/front.gif "Treecko: Small hooks on the bottom of its feet catch on walls and ceilings. That is how it can hang from above.") | ![Treecko](../assets/sprites/treecko/front_shiny.png "Treecko: Small hooks on the bottom of its feet catch on walls and ceilings. That is how it can hang from above.") | ![Treecko](../assets/sprites/treecko/back.png "Treecko: Small hooks on the bottom of its feet catch on walls and ceilings. That is how it can hang from above.") | ![Treecko](../assets/sprites/treecko/back_shiny.png "Treecko: Small hooks on the bottom of its feet catch on walls and ceilings. That is how it can hang from above.") |
...
|------------|---------|--------|--------|-----------|---------|
| #252 | ![grass](../assets/types/grass.png "Grass"){: width="48"} | 0.5 m /<br>1.6 ft | 5.0 kg /<br>11.0 lbs | 1. <span class="tooltip" title="Powers up Grass-type moves in a pinch.">Overgrow</span><br>2. <span class="tooltip" title="Raises Speed if a held item is used.">Unburden</span> | N/A |
