...
|-------|-------|------|-------|
| ![Solrock](../assets/sprites/solrock/front.gif "Solrock: When it rotates itself, it gives off light similar to the sun, thus blinding its foes.") | ![Solrock](../assets/sprites/solrock/front_shiny.png "Solrock: When it rotates itself, it gives off light similar to the sun, thus blinding its foes.") | ![Solrock](../assets/sprites/solrock/back.png "Solrock: When it rotates itself, it gives off light similar to the sun, thus blinding its foes.") | ![Solrock](../assets/sprites/solrock/back_shiny.png "Solrock: When it rotates itself, it gives off light similar to the sun, thus blinding its foes.") |
...
| 38 | <span class="tooltip" title="The foe slams the target with its steel-hard head. It may also make the target flinch.">Iron Head</span> | ![steel](../assets/types/steel.png "Steel"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 80 | 100 | 15 |
