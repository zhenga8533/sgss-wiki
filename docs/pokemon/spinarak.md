...
|-------|-------|------|-------|
| ![Spinarak](../assets/sprites/spinarak/front.gif "Spinarak: It spins a web using fine--but durable--thread. It then waits patiently for prey to be trapped.") | ![Spinarak](../assets/sprites/spinarak/front_shiny.png "Spinarak: It spins a web using fine--but durable--thread. It then waits patiently for prey to be trapped.") | ![Spinarak](../assets/sprites/spinarak/back.png "Spinarak: It spins a web using fine--but durable--thread. It then waits patiently for prey to be trapped.") | ![Spinarak](../assets/sprites/spinarak/back_shiny.png "Spinarak: It spins a web using fine--but durable--thread. It then waits patiently for prey to be trapped.") |
...
|------------|---------|--------|--------|-----------|---------|
| #167 | ![bug](../assets/types/bug.png "Bug"){: width="48"}<br>![poison](../assets/types/poison.png "Poison"){: width="48"} | 0.5 m /<br>1.6 ft | 8.5 kg /<br>18.7 lbs | 1. <span class="tooltip" title="Powers up Bug-type moves in a pinch.">Swarm</span><br>2. <span class="tooltip" title="Prevents the Pokémon from falling asleep.">Insomnia</span><br>3. <span class="tooltip" title="Powers up moves if they become critical hits.">Sniper</span> | N/A |
...
| 47 | <span class="tooltip" title="A slashing attack that may also leave the target poisoned. It has a high critical-hit ratio.">Cross Poison</span> | ![poison](../assets/types/poison.png "Poison"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 70 | 100 | 20 |
