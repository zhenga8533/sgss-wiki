...
|-------|-------|------|-------|
| ![Castform](../assets/sprites/castform/front.gif "Castform: This Pokémon can change its cells, taking different forms based on the temperature and humidity.") | ![Castform](../assets/sprites/castform/front_shiny.png "Castform: This Pokémon can change its cells, taking different forms based on the temperature and humidity.") | ![Castform](../assets/sprites/castform/back.png "Castform: This Pokémon can change its cells, taking different forms based on the temperature and humidity.") | ![Castform](../assets/sprites/castform/back_shiny.png "Castform: This Pokémon can change its cells, taking different forms based on the temperature and humidity.") |
