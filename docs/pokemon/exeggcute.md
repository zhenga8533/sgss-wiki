...
**Sacred Gold:** Their shells are very durable. Even if they crack, they can survive without spilling their contents.

**Storm Silver:** Using telepathy only they can employ, they always form a cluster of six EXEGGCUTE.
...
|-------|-------|------|-------|
| ![Exeggcute](../assets/sprites/exeggcute/front.gif "Exeggcute: Using telepathy only they can employ, they always form a cluster of six EXEGGCUTE.") | ![Exeggcute](../assets/sprites/exeggcute/front_shiny.png "Exeggcute: Using telepathy only they can employ, they always form a cluster of six EXEGGCUTE.") | ![Exeggcute](../assets/sprites/exeggcute/back.png "Exeggcute: Using telepathy only they can employ, they always form a cluster of six EXEGGCUTE.") | ![Exeggcute](../assets/sprites/exeggcute/back_shiny.png "Exeggcute: Using telepathy only they can employ, they always form a cluster of six EXEGGCUTE.") |
...
| 3 | <span class="tooltip" title="A nutrient-draining attack. The user’s HP is restored by half the damage taken by the target.">Mega Drain</span> | ![grass](../assets/types/grass.png "Grass"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 40 | 100 | 15 |
