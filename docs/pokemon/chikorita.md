...
**Sacred Gold:** A sweet aroma gently wafts from the leaf on its head. It is docile and loves to soak up sunrays.

**Storm Silver:** Its pleasantly aromatic leaf has the ability to check humidity and temperature.
...
|-------|-------|------|-------|
| ![Chikorita](../assets/sprites/chikorita/front.gif "Chikorita: Its pleasantly aromatic leaf has the ability to check humidity and temperature.") | ![Chikorita](../assets/sprites/chikorita/front_shiny.png "Chikorita: Its pleasantly aromatic leaf has the ability to check humidity and temperature.") | ![Chikorita](../assets/sprites/chikorita/back.png "Chikorita: Its pleasantly aromatic leaf has the ability to check humidity and temperature.") | ![Chikorita](../assets/sprites/chikorita/back_shiny.png "Chikorita: Its pleasantly aromatic leaf has the ability to check humidity and temperature.") |
...
|------------|---------|--------|--------|-----------|---------|
| #152 | ![grass](../assets/types/grass.png "Grass"){: width="48"} | 0.9 m /<br>3.0 ft | 6.4 kg /<br>14.1 lbs | 1. <span class="tooltip" title="Powers up Grass-type moves in a pinch.">Overgrow</span><br>2. <span class="tooltip" title="Prevents problems with status in sunny weather.">Leaf Guard</span> | N/A |
