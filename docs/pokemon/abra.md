...
**Sacred Gold:** It senses impending attacks and teleports away to safety before the actual attacks can strike.

**Storm Silver:** If it decides to teleport randomly, it evokes the illusion that it has created copies of itself.
...
|-------|-------|------|-------|
| ![Abra](../assets/sprites/abra/front.gif "Abra: If it decides to teleport randomly, it evokes the illusion that it has created copies of itself.") | ![Abra](../assets/sprites/abra/front_shiny.png "Abra: If it decides to teleport randomly, it evokes the illusion that it has created copies of itself.") | ![Abra](../assets/sprites/abra/back.png "Abra: If it decides to teleport randomly, it evokes the illusion that it has created copies of itself.") | ![Abra](../assets/sprites/abra/back_shiny.png "Abra: If it decides to teleport randomly, it evokes the illusion that it has created copies of itself.") |
...
|------------|---------|--------|--------|-----------|---------|
| #63 | ![psychic](../assets/types/psychic.png "Psychic"){: width="48"} | 0.9 m /<br>3.0 ft | 19.5 kg /<br>43.0 lbs | 1. <span class="tooltip" title="Passes a burn, poison, or paralysis to the foe.">Synchronize</span><br>2. <span class="tooltip" title="The Pokémon is protected from flinching.">Inner Focus</span><br>3. <span class="tooltip" title="The Pokémon only takes damage from attacks.">Magic Guard</span> | #20 |
