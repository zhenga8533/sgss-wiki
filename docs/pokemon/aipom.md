...
**Sacred Gold:** Its tail is so powerful that it can use it to grab a tree branch and hold itself up in the air.

**Storm Silver:** It lives atop tall trees. When leaping from branch to branch, it deftly uses its tail for balance.
...
|-------|-------|------|-------|
| ![Aipom](../assets/sprites/aipom/front.gif "Aipom: It lives atop tall trees. When leaping from branch to branch, it deftly uses its tail for balance.") | ![Aipom](../assets/sprites/aipom/front_shiny.png "Aipom: It lives atop tall trees. When leaping from branch to branch, it deftly uses its tail for balance.") | ![Aipom](../assets/sprites/aipom/back.png "Aipom: It lives atop tall trees. When leaping from branch to branch, it deftly uses its tail for balance.") | ![Aipom](../assets/sprites/aipom/back_shiny.png "Aipom: It lives atop tall trees. When leaping from branch to branch, it deftly uses its tail for balance.") |

### Female Sprites

| Front | Shiny | Back | Shiny |
|-------|-------|------|-------|
| ![Aipom](../assets/sprites/aipom/front_female.gif "Aipom: It lives atop tall trees. When leaping from branch to branch, it deftly uses its tail for balance.") | ![Aipom](../assets/sprites/aipom/front_shiny_female.png "Aipom: It lives atop tall trees. When leaping from branch to branch, it deftly uses its tail for balance.") | ![Aipom](../assets/sprites/aipom/back_female.png "Aipom: It lives atop tall trees. When leaping from branch to branch, it deftly uses its tail for balance.") | ![Aipom](../assets/sprites/aipom/back_shiny_female.png "Aipom: It lives atop tall trees. When leaping from branch to branch, it deftly uses its tail for balance.") |
...
| 32 | <span class="tooltip" title="The user slams the foe with a long tail, vines, etc. The target is hit twice in a row.">Double Hit</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 35 | 90 | 10 |
...
| 46 | <span class="tooltip" title="An attack that hits first and makes the target flinch. It only works the first turn the user is in battle.">Fake Out</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 40 | 100 | 10 |
