...
|-------|-------|------|-------|
| ![Bonsly](../assets/sprites/bonsly/front.gif "Bonsly: In order to adjust the level of fluids in its body, it exudes water from its eyes. This makes it appear to be crying.") | ![Bonsly](../assets/sprites/bonsly/front_shiny.png "Bonsly: In order to adjust the level of fluids in its body, it exudes water from its eyes. This makes it appear to be crying.") | ![Bonsly](../assets/sprites/bonsly/back.png "Bonsly: In order to adjust the level of fluids in its body, it exudes water from its eyes. This makes it appear to be crying.") | ![Bonsly](../assets/sprites/bonsly/back_shiny.png "Bonsly: In order to adjust the level of fluids in its body, it exudes water from its eyes. This makes it appear to be crying.") |
...
|------------|---------|--------|--------|-----------|---------|
| #438 | ![rock](../assets/types/rock.png "Rock"){: width="48"} | 0.5 m /<br>1.6 ft | 15.0 kg /<br>33.1 lbs | 1. <span class="tooltip" title="It is protected against 1-hit KO attacks.">Sturdy</span><br>2. <span class="tooltip" title="Protects the Pokémon from recoil damage.">Rock Head</span> | #92 |
