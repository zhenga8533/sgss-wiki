...
|-------|-------|------|-------|
| ![Sentret](../assets/sprites/sentret/front.gif "Sentret: It stands on its tail so it can see a long way. If it spots an enemy, it cries loudly to warn its kind.") | ![Sentret](../assets/sprites/sentret/front_shiny.png "Sentret: It stands on its tail so it can see a long way. If it spots an enemy, it cries loudly to warn its kind.") | ![Sentret](../assets/sprites/sentret/back.png "Sentret: It stands on its tail so it can see a long way. If it spots an enemy, it cries loudly to warn its kind.") | ![Sentret](../assets/sprites/sentret/back_shiny.png "Sentret: It stands on its tail so it can see a long way. If it spots an enemy, it cries loudly to warn its kind.") |
...
|------------|---------|--------|--------|-----------|---------|
| #161 | ![normal](../assets/types/normal.png "Normal"){: width="48"} | 0.8 m /<br>2.6 ft | 6.0 kg /<br>13.2 lbs | 1. <span class="tooltip" title="The Pokémon may pick up items.">Pickup</span><br>2. <span class="tooltip" title="Prevents the Pokémon from losing accuracy.">Keen Eye</span> | N/A |
