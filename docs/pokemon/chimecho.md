...
|-------|-------|------|-------|
| ![Chimecho](../assets/sprites/chimecho/front.gif "Chimecho: It uses the sucker on its head to hang from a tree or from eaves. It can produce seven different tones.") | ![Chimecho](../assets/sprites/chimecho/front_shiny.png "Chimecho: It uses the sucker on its head to hang from a tree or from eaves. It can produce seven different tones.") | ![Chimecho](../assets/sprites/chimecho/back.png "Chimecho: It uses the sucker on its head to hang from a tree or from eaves. It can produce seven different tones.") | ![Chimecho](../assets/sprites/chimecho/back_shiny.png "Chimecho: It uses the sucker on its head to hang from a tree or from eaves. It can produce seven different tones.") |

### Female Sprites

| Front | Shiny | Back | Shiny |
|-------|-------|------|-------|
| ? | ? | ![Chimecho](../assets/sprites/chimecho/back_female.png "Chimecho: It uses the sucker on its head to hang from a tree or from eaves. It can produce seven different tones.") | ![Chimecho](../assets/sprites/chimecho/back_shiny_female.png "Chimecho: It uses the sucker on its head to hang from a tree or from eaves. It can produce seven different tones.") |
...
|----------|------------|-----------------|-----------|-------------|------------|
| 1 Special Attack<br>1 Special Defense | 45 | 70 | 159 | Fast | <span class="tooltip" title="If held by a Pokémon, it weakens a foe’s supereffective Dark-type attack.">Colbur Berry</span> (5%) |
...
| 52 | <span class="tooltip" title="The user employs hypnotic suggestion to make the target fall into a deep sleep.">Hypnosis</span> | ![psychic](../assets/types/psychic.png "Psychic"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 60 | 20 |
