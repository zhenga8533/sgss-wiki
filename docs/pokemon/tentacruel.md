...
**Sacred Gold:** Its 80 tentacles absorb water and stretch almost endlessly to constrict its prey and enemies.
...
| 26 | <span class="tooltip" title="The user throws up a sturdy wall that sharply raises its Defense stat. ">Barrier</span> | ![psychic](../assets/types/psychic.png "Psychic"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 20 |
