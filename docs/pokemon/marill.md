...
|-------|-------|------|-------|
| ![Marill](../assets/sprites/marill/front.gif "Marill: The end of its tail serves as a buoy that keeps it from drowning, even in a vicious current.") | ![Marill](../assets/sprites/marill/front_shiny.png "Marill: The end of its tail serves as a buoy that keeps it from drowning, even in a vicious current.") | ![Marill](../assets/sprites/marill/back.png "Marill: The end of its tail serves as a buoy that keeps it from drowning, even in a vicious current.") | ![Marill](../assets/sprites/marill/back_shiny.png "Marill: The end of its tail serves as a buoy that keeps it from drowning, even in a vicious current.") |
