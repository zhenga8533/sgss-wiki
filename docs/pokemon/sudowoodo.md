...
**Sacred Gold:** Although it always pretends to be a tree, its composition appears more similar to rock than to vegetation.

**Storm Silver:** It disguises itself as a tree to avoid attack. It hates water, so it will disappear if it starts raining.
...
|-------|-------|------|-------|
| ![Sudowoodo](../assets/sprites/sudowoodo/front.gif "Sudowoodo: It disguises itself as a tree to avoid attack. It hates water, so it will disappear if it starts raining.") | ![Sudowoodo](../assets/sprites/sudowoodo/front_shiny.png "Sudowoodo: It disguises itself as a tree to avoid attack. It hates water, so it will disappear if it starts raining.") | ![Sudowoodo](../assets/sprites/sudowoodo/back.png "Sudowoodo: It disguises itself as a tree to avoid attack. It hates water, so it will disappear if it starts raining.") | ![Sudowoodo](../assets/sprites/sudowoodo/back_shiny.png "Sudowoodo: It disguises itself as a tree to avoid attack. It hates water, so it will disappear if it starts raining.") |

### Female Sprites

| Front | Shiny | Back | Shiny |
|-------|-------|------|-------|
| ![Sudowoodo](../assets/sprites/sudowoodo/front_female.gif "Sudowoodo: It disguises itself as a tree to avoid attack. It hates water, so it will disappear if it starts raining.") | ![Sudowoodo](../assets/sprites/sudowoodo/front_shiny_female.png "Sudowoodo: It disguises itself as a tree to avoid attack. It hates water, so it will disappear if it starts raining.") | ![Sudowoodo](../assets/sprites/sudowoodo/back_female.png "Sudowoodo: It disguises itself as a tree to avoid attack. It hates water, so it will disappear if it starts raining.") | ![Sudowoodo](../assets/sprites/sudowoodo/back_shiny_female.png "Sudowoodo: It disguises itself as a tree to avoid attack. It hates water, so it will disappear if it starts raining.") |
...
|---|----|--------|---------|---------|---------|-------|
| **Base** | 75 | 115 | 130 | 30 | 80 | 30 |
| **Min** | 260 | 211 | 238 | 58 | 148 | 58 |
| **Max** | 354 | 361 | 394 | 174 | 284 | 174 |
