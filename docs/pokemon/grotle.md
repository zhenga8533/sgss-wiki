...
|-------|-------|------|-------|
| ![Grotle](../assets/sprites/grotle/front.gif "Grotle: A GROTLE that lives in the forest is said to have its own secret springwater.") | ![Grotle](../assets/sprites/grotle/front_shiny.png "Grotle: A GROTLE that lives in the forest is said to have its own secret springwater.") | ![Grotle](../assets/sprites/grotle/back.png "Grotle: A GROTLE that lives in the forest is said to have its own secret springwater.") | ![Grotle](../assets/sprites/grotle/back_shiny.png "Grotle: A GROTLE that lives in the forest is said to have its own secret springwater.") |
