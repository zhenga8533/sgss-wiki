...
| 34 | <span class="tooltip" title="The user grabs the foe and recklessly dives for the ground. It also hurts the user slightly.">Submission</span> | ![fighting](../assets/types/fighting.png "Fighting"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 80 | 80 | 20 |
