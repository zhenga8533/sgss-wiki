...
|-------|-------|------|-------|
| ![Rayquaza](../assets/sprites/rayquaza/front.gif "Rayquaza: It flies in the ozone layer, way up high in the sky. Until recently, no one had ever seen it.") | ![Rayquaza](../assets/sprites/rayquaza/front_shiny.png "Rayquaza: It flies in the ozone layer, way up high in the sky. Until recently, no one had ever seen it.") | ![Rayquaza](../assets/sprites/rayquaza/back.png "Rayquaza: It flies in the ozone layer, way up high in the sky. Until recently, no one had ever seen it.") | ![Rayquaza](../assets/sprites/rayquaza/back_shiny.png "Rayquaza: It flies in the ozone layer, way up high in the sky. Until recently, no one had ever seen it.") |
...
| 65 | <span class="tooltip" title="The user soars, then strikes on the second turn. It can also be used for flying to any familiar town.">Fly</span> | ![flying](../assets/types/flying.png "Flying"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 90 | 95 | 15 |
