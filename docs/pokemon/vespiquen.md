...
|-------|-------|------|-------|
| ![Vespiquen](../assets/sprites/vespiquen/front.gif "Vespiquen: It raises grubs in the holes in its body. It secretes pheromones to control COMBEE.") | ![Vespiquen](../assets/sprites/vespiquen/front_shiny.png "Vespiquen: It raises grubs in the holes in its body. It secretes pheromones to control COMBEE.") | ![Vespiquen](../assets/sprites/vespiquen/back.png "Vespiquen: It raises grubs in the holes in its body. It secretes pheromones to control COMBEE.") | ![Vespiquen](../assets/sprites/vespiquen/back_shiny.png "Vespiquen: It raises grubs in the holes in its body. It secretes pheromones to control COMBEE.") |
...
|------------|---------|--------|--------|-----------|---------|
| #416 | ![bug](../assets/types/bug.png "Bug"){: width="48"}<br>![flying](../assets/types/flying.png "Flying"){: width="48"} | 1.2 m /<br>3.9 ft | 38.5 kg /<br>84.9 lbs | 1. <span class="tooltip" title="The Pokémon raises the foe’s PP usage.">Pressure</span><br>2. <span class="tooltip" title="Lowers the foe’s Attack stat.">Intimidate</span> | #54 |
...
| 27 | <span class="tooltip" title="The user calls out its underlings to heal it. The user regains up to half of its max HP.">Heal Order</span> | ![bug](../assets/types/bug.png "Bug"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 10 |
...
| 39 | <span class="tooltip" title="The user calls out its underlings to shield its body, raising its Defense and Sp. Def stats.">Defend Order</span> | ![bug](../assets/types/bug.png "Bug"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 10 |
