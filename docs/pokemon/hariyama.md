...
|------------|---------|--------|--------|-----------|---------|
| #297 | ![fighting](../assets/types/fighting.png "Fighting"){: width="48"} | 2.3 m /<br>7.5 ft | 253.8 kg /<br>559.5 lbs | 1. <span class="tooltip" title="Ups resistance to Fire-​ and Ice-type moves.">Thick Fat</span><br>2. <span class="tooltip" title="Boosts Attack if there is a status problem.">Guts</span> | N/A |
