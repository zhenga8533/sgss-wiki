...
|-------|-------|------|-------|
| ![Marowak](../assets/sprites/marowak/front.gif "Marowak: It collects bones from an unknown place. Some whisper that a MAROWAK graveyard exists somewhere in the world.") | ![Marowak](../assets/sprites/marowak/front_shiny.png "Marowak: It collects bones from an unknown place. Some whisper that a MAROWAK graveyard exists somewhere in the world.") | ![Marowak](../assets/sprites/marowak/back.png "Marowak: It collects bones from an unknown place. Some whisper that a MAROWAK graveyard exists somewhere in the world.") | ![Marowak](../assets/sprites/marowak/back_shiny.png "Marowak: It collects bones from an unknown place. Some whisper that a MAROWAK graveyard exists somewhere in the world.") |
...
|------------|---------|--------|--------|-----------|---------|
| #105 | ![ground](../assets/types/ground.png "Ground"){: width="48"} | 1.0 m /<br>3.3 ft | 45.0 kg /<br>99.2 lbs | 1. <span class="tooltip" title="Protects the Pokémon from recoil damage.">Rock Head</span><br>2. <span class="tooltip" title="The Pokémon is protected against critical hits.">Battle Armor</span> | N/A |
...
|----------|------------|-----------------|-----------|-------------|------------|
| 2 Defense | 75 | 50 | 140 | Medium | <span class="tooltip" title="An item to be held by CUBONE or MAROWAK. It is a hard bone of some sort that boosts the Attack stat.">Thick Club</span> (5%) |
