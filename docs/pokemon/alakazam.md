...
**Sacred Gold:** Closing both its eyes heightens all its other senses. This enables it to use its abilities to their extremes.

**Storm Silver:** Its brain cells multiply continually until it dies. As a result, it remembers everything.
...
|-------|-------|------|-------|
| ![Alakazam](../assets/sprites/alakazam/front.gif "Alakazam: Its brain cells multiply continually until it dies. As a result, it remembers everything.") | ![Alakazam](../assets/sprites/alakazam/front_shiny.png "Alakazam: Its brain cells multiply continually until it dies. As a result, it remembers everything.") | ![Alakazam](../assets/sprites/alakazam/back.png "Alakazam: Its brain cells multiply continually until it dies. As a result, it remembers everything.") | ![Alakazam](../assets/sprites/alakazam/back_shiny.png "Alakazam: Its brain cells multiply continually until it dies. As a result, it remembers everything.") |

### Female Sprites

| Front | Shiny | Back | Shiny |
|-------|-------|------|-------|
| ![Alakazam](../assets/sprites/alakazam/front_female.gif "Alakazam: Its brain cells multiply continually until it dies. As a result, it remembers everything.") | ![Alakazam](../assets/sprites/alakazam/front_shiny_female.png "Alakazam: Its brain cells multiply continually until it dies. As a result, it remembers everything.") | ![Alakazam](../assets/sprites/alakazam/back_female.png "Alakazam: Its brain cells multiply continually until it dies. As a result, it remembers everything.") | ![Alakazam](../assets/sprites/alakazam/back_shiny_female.png "Alakazam: Its brain cells multiply continually until it dies. As a result, it remembers everything.") |
...
|------------|---------|--------|--------|-----------|---------|
| #65 | ![psychic](../assets/types/psychic.png "Psychic"){: width="48"} | 1.5 m /<br>4.9 ft | 48.0 kg /<br>105.8 lbs | 1. <span class="tooltip" title="Passes a burn, poison, or paralysis to the foe.">Synchronize</span><br>2. <span class="tooltip" title="The Pokémon is protected from flinching.">Inner Focus</span><br>3. <span class="tooltip" title="The Pokémon only takes damage from attacks.">Magic Guard</span> | #22 |
...
| 36 | <span class="tooltip" title="The user quietly focuses its mind and calms its spirit to raise its Sp. Atk and Sp. Def stats.">Calm Mind</span> | ![psychic](../assets/types/psychic.png "Psychic"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 20 |
