...
|-------|-------|------|-------|
| ![Pelipper](../assets/sprites/pelipper/front.gif "Pelipper: It protects its young in its beak. It bobs on waves, resting on them on days when the waters are calm.") | ![Pelipper](../assets/sprites/pelipper/front_shiny.png "Pelipper: It protects its young in its beak. It bobs on waves, resting on them on days when the waters are calm.") | ![Pelipper](../assets/sprites/pelipper/back.png "Pelipper: It protects its young in its beak. It bobs on waves, resting on them on days when the waters are calm.") | ![Pelipper](../assets/sprites/pelipper/back_shiny.png "Pelipper: It protects its young in its beak. It bobs on waves, resting on them on days when the waters are calm.") |
...
|------------|---------|--------|--------|-----------|---------|
| #279 | ![water](../assets/types/water.png "Water"){: width="48"}<br>![flying](../assets/types/flying.png "Flying"){: width="48"} | 1.2 m /<br>3.9 ft | 28.0 kg /<br>61.7 lbs | 1. <span class="tooltip" title="Prevents the Pokémon from losing accuracy.">Keen Eye</span><br>2. <span class="tooltip" title="The Pokémon makes it rain if it appears in battle.">Drizzle</span><br>3. <span class="tooltip" title="The Pokémon gradually recovers HP in rain.">Rain Dish</span> | #120 |
...
| 11 | <span class="tooltip" title="The foe is struck with large, imposing wings spread wide to inflict damage. ">Wing Attack</span> | ![flying](../assets/types/flying.png "Flying"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 60 | 100 | 35 |
...
| 63 | <span class="tooltip" title="Inflicts regular damage.  Has a 30% chance to confuse the target.  This move can hit Pokémon under the effect of bounce, fly, or sky drop.  During rain dance, this move has 100% accuracy.  During sunny day, this move has 50% accuracy.">Hurricane</span> | ![flying](../assets/types/flying.png "Flying"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 110 | 70 | 10 |
