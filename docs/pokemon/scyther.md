...
|-------|-------|------|-------|
| ![Scyther](../assets/sprites/scyther/front.gif "Scyther: When it moves, it leaves only a blur. If it hides in grass, its protective coloration makes it invisible.") | ![Scyther](../assets/sprites/scyther/front_shiny.png "Scyther: When it moves, it leaves only a blur. If it hides in grass, its protective coloration makes it invisible.") | ![Scyther](../assets/sprites/scyther/back.png "Scyther: When it moves, it leaves only a blur. If it hides in grass, its protective coloration makes it invisible.") | ![Scyther](../assets/sprites/scyther/back_shiny.png "Scyther: When it moves, it leaves only a blur. If it hides in grass, its protective coloration makes it invisible.") |

### Female Sprites

| Front | Shiny | Back | Shiny |
|-------|-------|------|-------|
| ![Scyther](../assets/sprites/scyther/front_female.gif "Scyther: When it moves, it leaves only a blur. If it hides in grass, its protective coloration makes it invisible.") | ![Scyther](../assets/sprites/scyther/front_shiny_female.png "Scyther: When it moves, it leaves only a blur. If it hides in grass, its protective coloration makes it invisible.") | ![Scyther](../assets/sprites/scyther/back_female.png "Scyther: When it moves, it leaves only a blur. If it hides in grass, its protective coloration makes it invisible.") | ![Scyther](../assets/sprites/scyther/back_shiny_female.png "Scyther: When it moves, it leaves only a blur. If it hides in grass, its protective coloration makes it invisible.") |
...
|------------|---------|--------|--------|-----------|---------|
| #123 | ![bug](../assets/types/bug.png "Bug"){: width="48"}<br>![flying](../assets/types/flying.png "Flying"){: width="48"} | 1.5 m /<br>4.9 ft | 56.0 kg /<br>123.5 lbs | 1. <span class="tooltip" title="Powers up Bug-type moves in a pinch.">Swarm</span><br>2. <span class="tooltip" title="Powers up the Pokémon’s weaker moves.">Technician</span><br>3. <span class="tooltip" title="Raises Speed each time the Pokémon flinches.">Steadfast</span> | N/A |
...
| 21 | <span class="tooltip" title="The foe is struck with large, imposing wings spread wide to inflict damage. ">Wing Attack</span> | ![flying](../assets/types/flying.png "Flying"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 60 | 100 | 35 |
...
| 33 | <span class="tooltip" title="The user bites the foe. If the foe is holding a Berry, the user eats it and gains its effect.">Bug Bite</span> | ![bug](../assets/types/bug.png "Bug"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 60 | 100 | 20 |
...
| 49 | <span class="tooltip" title="The user slams the foe with a long tail, vines, etc. The target is hit twice in a row.">Double Hit</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 35 | 90 | 10 |
...
| 65 | <span class="tooltip" title="The user slashes the foe the instant an opportunity arises. It has a high critical-hit ratio.">Night Slash</span> | ![dark](../assets/types/dark.png "Dark"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 70 | 100 | 15 |
