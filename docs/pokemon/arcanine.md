...
**Sacred Gold:** This legendary Chinese Pokémon is considered magnificent. Many people are enchanted by its grand mane.

**Storm Silver:** Its magnificent bark conveys a sense of majesty. Anyone hearing it can’t help but grovel before it.
...
|-------|-------|------|-------|
| ![Arcanine](../assets/sprites/arcanine/front.gif "Arcanine: Its magnificent bark conveys a sense of majesty. Anyone hearing it can’t help but grovel before it.") | ![Arcanine](../assets/sprites/arcanine/front_shiny.png "Arcanine: Its magnificent bark conveys a sense of majesty. Anyone hearing it can’t help but grovel before it.") | ![Arcanine](../assets/sprites/arcanine/back.png "Arcanine: Its magnificent bark conveys a sense of majesty. Anyone hearing it can’t help but grovel before it.") | ![Arcanine](../assets/sprites/arcanine/back_shiny.png "Arcanine: Its magnificent bark conveys a sense of majesty. Anyone hearing it can’t help but grovel before it.") |
...
|----------|------------|-----------------|-----------|-------------|------------|
| 2 Attack | 75 | 50 | 194 | Slow | <span class="tooltip" title="It may be used or held by a Pokémon to recover from a burn.">Rawst Berry</span> (100%) |
...
| 1 | <span class="tooltip" title="The user fights the foe up close without guarding itself. It also cuts the user’s Defense and Sp. Def.">Close Combat</span> | ![fighting](../assets/types/fighting.png "Fighting"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 120 | 100 | 5 |
