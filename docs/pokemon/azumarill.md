...
|-------|-------|------|-------|
| ![Azumarill](../assets/sprites/azumarill/front.gif "Azumarill: When it plays in water, it rolls up its elongated ears to prevent their insides from getting wet.") | ![Azumarill](../assets/sprites/azumarill/front_shiny.png "Azumarill: When it plays in water, it rolls up its elongated ears to prevent their insides from getting wet.") | ![Azumarill](../assets/sprites/azumarill/back.png "Azumarill: When it plays in water, it rolls up its elongated ears to prevent their insides from getting wet.") | ![Azumarill](../assets/sprites/azumarill/back_shiny.png "Azumarill: When it plays in water, it rolls up its elongated ears to prevent their insides from getting wet.") |
...
|------------|---------|--------|--------|-----------|---------|
| #184 | ![water](../assets/types/water.png "Water"){: width="48"}<br>![fairy](../assets/types/fairy.png "Fairy"){: width="48"} | 0.8 m /<br>2.6 ft | 28.5 kg /<br>62.8 lbs | 1. <span class="tooltip" title="Ups resistance to Fire-​ and Ice-type moves.">Thick Fat</span><br>2. <span class="tooltip" title="Raises the Pokémon’s Attack stat.">Huge Power</span> | #126 |
