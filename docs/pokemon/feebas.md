...
|-------|-------|------|-------|
| ![Feebas](../assets/sprites/feebas/front.gif "Feebas: It is the shabbiest Pokémon of all. It forms in schools and lives at the bottom of rivers.") | ![Feebas](../assets/sprites/feebas/front_shiny.png "Feebas: It is the shabbiest Pokémon of all. It forms in schools and lives at the bottom of rivers.") | ![Feebas](../assets/sprites/feebas/back.png "Feebas: It is the shabbiest Pokémon of all. It forms in schools and lives at the bottom of rivers.") | ![Feebas](../assets/sprites/feebas/back_shiny.png "Feebas: It is the shabbiest Pokémon of all. It forms in schools and lives at the bottom of rivers.") |
...
|------------|---------|--------|--------|-----------|---------|
| #349 | ![water](../assets/types/water.png "Water"){: width="48"} | 0.6 m /<br>2.0 ft | 7.4 kg /<br>16.3 lbs | 1. <span class="tooltip" title="Boosts the Pokémon’s Speed in rain.">Swift Swim</span><br>2. <span class="tooltip" title="Prevents it from becoming infatuated.">Oblivious</span><br>3. <span class="tooltip" title="Powers up moves of the same type.">Adaptability</span> | #138 |
