...
|-------|-------|------|-------|
| ![Azurill](../assets/sprites/azurill/front.gif "Azurill: Its tail is packed full of the nutrients it needs to grow.") | ![Azurill](../assets/sprites/azurill/front_shiny.png "Azurill: Its tail is packed full of the nutrients it needs to grow.") | ![Azurill](../assets/sprites/azurill/back.png "Azurill: Its tail is packed full of the nutrients it needs to grow.") | ![Azurill](../assets/sprites/azurill/back_shiny.png "Azurill: Its tail is packed full of the nutrients it needs to grow.") |
...
|------------|---------|--------|--------|-----------|---------|
| #298 | ![normal](../assets/types/normal.png "Normal"){: width="48"}<br>![fairy](../assets/types/fairy.png "Fairy"){: width="48"} | 0.2 m /<br>0.7 ft | 2.0 kg /<br>4.4 lbs | 1. <span class="tooltip" title="Ups resistance to Fire-​ and Ice-type moves.">Thick Fat</span><br>2. <span class="tooltip" title="Raises the Pokémon’s Attack stat.">Huge Power</span> | #124 |
