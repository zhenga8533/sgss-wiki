...
**Sacred Gold:** With its acute hearing, it can pick up sounds from far away. It usually hides in quiet places.

**Storm Silver:** Its very sensitive ears let it distinguish distant sounds. As a result, it prefers quiet places.
...
|-------|-------|------|-------|
| ![Clefable](../assets/sprites/clefable/front.gif "Clefable: Its very sensitive ears let it distinguish distant sounds. As a result, it prefers quiet places.") | ![Clefable](../assets/sprites/clefable/front_shiny.png "Clefable: Its very sensitive ears let it distinguish distant sounds. As a result, it prefers quiet places.") | ![Clefable](../assets/sprites/clefable/back.png "Clefable: Its very sensitive ears let it distinguish distant sounds. As a result, it prefers quiet places.") | ![Clefable](../assets/sprites/clefable/back_shiny.png "Clefable: Its very sensitive ears let it distinguish distant sounds. As a result, it prefers quiet places.") |
...
|------------|---------|--------|--------|-----------|---------|
| #36 | ![fairy](../assets/types/fairy.png "Fairy"){: width="48"} | 1.3 m /<br>4.3 ft | 40.0 kg /<br>88.2 lbs | 1. <span class="tooltip" title="Ignores any change in ability by the foe.">Unaware</span><br>2. <span class="tooltip" title="The Pokémon only takes damage from attacks.">Magic Guard</span> | #101 |
