...
|-------|-------|------|-------|
| ![Whismur](../assets/sprites/whismur/front.gif "Whismur: If it senses danger, it scares the foe by crying out with the volume of a jet-plane engine.") | ![Whismur](../assets/sprites/whismur/front_shiny.png "Whismur: If it senses danger, it scares the foe by crying out with the volume of a jet-plane engine.") | ![Whismur](../assets/sprites/whismur/back.png "Whismur: If it senses danger, it scares the foe by crying out with the volume of a jet-plane engine.") | ![Whismur](../assets/sprites/whismur/back_shiny.png "Whismur: If it senses danger, it scares the foe by crying out with the volume of a jet-plane engine.") |
...
|------------|---------|--------|--------|-----------|---------|
| #293 | ![normal](../assets/types/normal.png "Normal"){: width="48"} | 0.6 m /<br>2.0 ft | 16.3 kg /<br>35.9 lbs | 1. <span class="tooltip" title="Gives full immunity to all sound-based moves.">Soundproof</span><br>2. <span class="tooltip" title="This Pokémon's Speed rises one stage with each hit from a damaging dark-, ghost-, or bug-type move.">Rattled</span> | N/A |
