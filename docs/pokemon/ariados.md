...
|-------|-------|------|-------|
| ![Ariados](../assets/sprites/ariados/front.gif "Ariados: A single strand of a special string is endlessly spun out of its rear. The string leads back to its nest.") | ![Ariados](../assets/sprites/ariados/front_shiny.png "Ariados: A single strand of a special string is endlessly spun out of its rear. The string leads back to its nest.") | ![Ariados](../assets/sprites/ariados/back.png "Ariados: A single strand of a special string is endlessly spun out of its rear. The string leads back to its nest.") | ![Ariados](../assets/sprites/ariados/back_shiny.png "Ariados: A single strand of a special string is endlessly spun out of its rear. The string leads back to its nest.") |
...
|------------|---------|--------|--------|-----------|---------|
| #168 | ![bug](../assets/types/bug.png "Bug"){: width="48"}<br>![poison](../assets/types/poison.png "Poison"){: width="48"} | 1.1 m /<br>3.6 ft | 33.5 kg /<br>73.9 lbs | 1. <span class="tooltip" title="Powers up Bug-type moves in a pinch.">Swarm</span><br>2. <span class="tooltip" title="Prevents the Pokémon from falling asleep.">Insomnia</span><br>3. <span class="tooltip" title="Powers up moves if they become critical hits.">Sniper</span> | N/A |
...
| 55 | <span class="tooltip" title="A slashing attack that may also leave the target poisoned. It has a high critical-hit ratio.">Cross Poison</span> | ![poison](../assets/types/poison.png "Poison"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 70 | 100 | 20 |
