...
|-------|-------|------|-------|
| ![Zubat](../assets/sprites/zubat/front.gif "Zubat: Capable of flying safely in dark places, it emits ultrasonic cries to check for any obstacles.") | ![Zubat](../assets/sprites/zubat/front_shiny.png "Zubat: Capable of flying safely in dark places, it emits ultrasonic cries to check for any obstacles.") | ![Zubat](../assets/sprites/zubat/back.png "Zubat: Capable of flying safely in dark places, it emits ultrasonic cries to check for any obstacles.") | ![Zubat](../assets/sprites/zubat/back_shiny.png "Zubat: Capable of flying safely in dark places, it emits ultrasonic cries to check for any obstacles.") |

### Female Sprites

| Front | Shiny | Back | Shiny |
|-------|-------|------|-------|
| ![Zubat](../assets/sprites/zubat/front_female.gif "Zubat: Capable of flying safely in dark places, it emits ultrasonic cries to check for any obstacles.") | ![Zubat](../assets/sprites/zubat/front_shiny_female.png "Zubat: Capable of flying safely in dark places, it emits ultrasonic cries to check for any obstacles.") | ![Zubat](../assets/sprites/zubat/back_female.png "Zubat: Capable of flying safely in dark places, it emits ultrasonic cries to check for any obstacles.") | ![Zubat](../assets/sprites/zubat/back_shiny_female.png "Zubat: Capable of flying safely in dark places, it emits ultrasonic cries to check for any obstacles.") |
...
|------------|---------|--------|--------|-----------|---------|
| #41 | ![poison](../assets/types/poison.png "Poison"){: width="48"}<br>![flying](../assets/types/flying.png "Flying"){: width="48"} | 0.8 m /<br>2.6 ft | 7.5 kg /<br>16.5 lbs | 1. <span class="tooltip" title="The Pokémon is protected from flinching.">Inner Focus</span><br>2. <span class="tooltip" title="Senses the foe’s dangerous moves.">Anticipation</span> | #28 |
...
| 37 | <span class="tooltip" title="The user bites the foe with toxic fangs. It may also leave the foe badly poisoned. ">Poison Fang</span> | ![poison](../assets/types/poison.png "Poison"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 50 | 100 | 15 |
