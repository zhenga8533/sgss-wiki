...
|-------|-------|------|-------|
| ![Castform Rainy](../assets/sprites/castform-rainy/front.png "Castform Rainy: This Pokémon can change its cells, taking different forms based on the temperature and humidity.") | ![Castform Rainy](../assets/sprites/castform-rainy/front_shiny.png "Castform Rainy: This Pokémon can change its cells, taking different forms based on the temperature and humidity.") | ![Castform Rainy](../assets/sprites/castform-rainy/back.png "Castform Rainy: This Pokémon can change its cells, taking different forms based on the temperature and humidity.") | ![Castform Rainy](../assets/sprites/castform-rainy/back_shiny.png "Castform Rainy: This Pokémon can change its cells, taking different forms based on the temperature and humidity.") |
...
|----------|------------|-----------------|-----------|-------------|------------|
| 1 None | 45 | 70 | 147 | Medium | <span class="tooltip" title="An item to be held by a Pokémon. It is a teardrop-shaped gem that ups the power of Water-type moves.">Mystic Water</span> (100%) |
...
| 20 | <span class="tooltip" title="The user attacks with its head. It may make the foe flinch. To find Pokémon, hit trees.">Headbutt</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 70 | 100 | 15 |
