...
|-------|-------|------|-------|
| ![Numel](../assets/sprites/numel/front.gif "Numel: The flaming magma it stores in the hump on its back is the source of its tremendous power.") | ![Numel](../assets/sprites/numel/front_shiny.png "Numel: The flaming magma it stores in the hump on its back is the source of its tremendous power.") | ![Numel](../assets/sprites/numel/back.png "Numel: The flaming magma it stores in the hump on its back is the source of its tremendous power.") | ![Numel](../assets/sprites/numel/back_shiny.png "Numel: The flaming magma it stores in the hump on its back is the source of its tremendous power.") |

### Female Sprites

| Front | Shiny | Back | Shiny |
|-------|-------|------|-------|
| ![Numel](../assets/sprites/numel/front_female.gif "Numel: The flaming magma it stores in the hump on its back is the source of its tremendous power.") | ![Numel](../assets/sprites/numel/front_shiny_female.png "Numel: The flaming magma it stores in the hump on its back is the source of its tremendous power.") | ![Numel](../assets/sprites/numel/back_female.png "Numel: The flaming magma it stores in the hump on its back is the source of its tremendous power.") | ![Numel](../assets/sprites/numel/back_shiny_female.png "Numel: The flaming magma it stores in the hump on its back is the source of its tremendous power.") |
...
| 45 | <span class="tooltip" title="The foe is scorched with an intense blast of fire. The target may also be left with a burn.">Flamethrower</span> | ![fire](../assets/types/fire.png "Fire"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 90 | 100 | 15 |
