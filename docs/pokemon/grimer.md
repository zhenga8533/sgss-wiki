...
|-------|-------|------|-------|
| ![Grimer](../assets/sprites/grimer/front.gif "Grimer: Wherever GRIMER has passed, so many germs are left behind that no plants will ever grow again.") | ![Grimer](../assets/sprites/grimer/front_shiny.png "Grimer: Wherever GRIMER has passed, so many germs are left behind that no plants will ever grow again.") | ![Grimer](../assets/sprites/grimer/back.png "Grimer: Wherever GRIMER has passed, so many germs are left behind that no plants will ever grow again.") | ![Grimer](../assets/sprites/grimer/back_shiny.png "Grimer: Wherever GRIMER has passed, so many germs are left behind that no plants will ever grow again.") |
...
| <span class="tooltip" title="The user throws a punch at the foe from the shadows. The punch lands without fail.">Shadow Punch</span> | ![ghost](../assets/types/ghost.png "Ghost"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 60 | — | 20 |
