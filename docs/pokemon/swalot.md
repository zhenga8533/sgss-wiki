...
|----------|------------|-----------------|-----------|-------------|------------|
| 2 None | 75 | 70 | 163 | Fast Then Very Slow | <span class="tooltip" title="A quite-large pearl that sparkles in a pretty silver color. It can be sold at a high price to shops.">Big Pearl</span> (5%) |
