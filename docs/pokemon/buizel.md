...
|-------|-------|------|-------|
| ![Buizel](../assets/sprites/buizel/front.gif "Buizel: It inflates its flotation sac, keeping its face above water in order to watch for prey movement.") | ![Buizel](../assets/sprites/buizel/front_shiny.png "Buizel: It inflates its flotation sac, keeping its face above water in order to watch for prey movement.") | ![Buizel](../assets/sprites/buizel/back.png "Buizel: It inflates its flotation sac, keeping its face above water in order to watch for prey movement.") | ![Buizel](../assets/sprites/buizel/back_shiny.png "Buizel: It inflates its flotation sac, keeping its face above water in order to watch for prey movement.") |

### Female Sprites

| Front | Shiny | Back | Shiny |
|-------|-------|------|-------|
| ![Buizel](../assets/sprites/buizel/front_female.gif "Buizel: It inflates its flotation sac, keeping its face above water in order to watch for prey movement.") | N/A | ![Buizel](../assets/sprites/buizel/back_female.png "Buizel: It inflates its flotation sac, keeping its face above water in order to watch for prey movement.") | ![Buizel](../assets/sprites/buizel/back_shiny_female.png "Buizel: It inflates its flotation sac, keeping its face above water in order to watch for prey movement.") |
...
|------------|---------|--------|--------|-----------|---------|
| #418 | ![water](../assets/types/water.png "Water"){: width="48"} | 0.7 m /<br>2.3 ft | 29.5 kg /<br>65.0 lbs | 1. <span class="tooltip" title="Boosts the Pokémon’s Speed in rain.">Swift Swim</span><br>2. <span class="tooltip" title="Powers up the Pokémon’s weaker moves.">Technician</span> | #56 |
...
| 36 | <span class="tooltip" title="Traps the foe inside a whirlpool that lasts for two to five turns. The user can pass through whirlpools.">Whirlpool</span> | ![water](../assets/types/water.png "Water"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 35 | 85 | 15 |
...
| 54 | <span class="tooltip" title="The user relaxes and lightens its body to move faster. It sharply boosts the Speed stat.">Agility</span> | ![psychic](../assets/types/psychic.png "Psychic"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 30 |
