...
|-------|-------|------|-------|
| ![Electrike](../assets/sprites/electrike/front.gif "Electrike: It stores electricity in its fur. It gives off sparks from all over its body in seasons when the air is dry.") | ![Electrike](../assets/sprites/electrike/front_shiny.png "Electrike: It stores electricity in its fur. It gives off sparks from all over its body in seasons when the air is dry.") | ![Electrike](../assets/sprites/electrike/back.png "Electrike: It stores electricity in its fur. It gives off sparks from all over its body in seasons when the air is dry.") | ![Electrike](../assets/sprites/electrike/back_shiny.png "Electrike: It stores electricity in its fur. It gives off sparks from all over its body in seasons when the air is dry.") |
