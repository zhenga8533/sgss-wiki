...
| 17 | <span class="tooltip" title="The user blocks the foe’s way with arms spread wide to prevent escape. ">Block</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 5 |
