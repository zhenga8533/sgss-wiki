...
|-------|-------|------|-------|
| ![Cacnea](../assets/sprites/cacnea/front.gif "Cacnea: It lives in arid locations. Its yellow flowers bloom once a year.") | ![Cacnea](../assets/sprites/cacnea/front_shiny.png "Cacnea: It lives in arid locations. Its yellow flowers bloom once a year.") | ![Cacnea](../assets/sprites/cacnea/back.png "Cacnea: It lives in arid locations. Its yellow flowers bloom once a year.") | ![Cacnea](../assets/sprites/cacnea/back_shiny.png "Cacnea: It lives in arid locations. Its yellow flowers bloom once a year.") |
...
| 45 | <span class="tooltip" title="The user lays roots that restore HP on every turn. Because it is rooted, it can’t switch out.">Ingrain</span> | ![grass](../assets/types/grass.png "Grass"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 20 |
