...
|-------|-------|------|-------|
| ![Roserade](../assets/sprites/roserade/front.gif "Roserade: Its sweet aroma attracts prey. Then it spews poison. The more toxic it is, the sweeter its aroma.") | ![Roserade](../assets/sprites/roserade/front_shiny.png "Roserade: Its sweet aroma attracts prey. Then it spews poison. The more toxic it is, the sweeter its aroma.") | ![Roserade](../assets/sprites/roserade/back.png "Roserade: Its sweet aroma attracts prey. Then it spews poison. The more toxic it is, the sweeter its aroma.") | ![Roserade](../assets/sprites/roserade/back_shiny.png "Roserade: Its sweet aroma attracts prey. Then it spews poison. The more toxic it is, the sweeter its aroma.") |

### Female Sprites

| Front | Shiny | Back | Shiny |
|-------|-------|------|-------|
| ![Roserade](../assets/sprites/roserade/front_female.gif "Roserade: Its sweet aroma attracts prey. Then it spews poison. The more toxic it is, the sweeter its aroma.") | ![Roserade](../assets/sprites/roserade/front_shiny_female.png "Roserade: Its sweet aroma attracts prey. Then it spews poison. The more toxic it is, the sweeter its aroma.") | ![Roserade](../assets/sprites/roserade/back_female.png "Roserade: Its sweet aroma attracts prey. Then it spews poison. The more toxic it is, the sweeter its aroma.") | ![Roserade](../assets/sprites/roserade/back_shiny_female.png "Roserade: Its sweet aroma attracts prey. Then it spews poison. The more toxic it is, the sweeter its aroma.") |
...
|------------|---------|--------|--------|-----------|---------|
| #407 | ![grass](../assets/types/grass.png "Grass"){: width="48"}<br>![poison](../assets/types/poison.png "Poison"){: width="48"} | 0.9 m /<br>3.0 ft | 14.5 kg /<br>32.0 lbs | 1. <span class="tooltip" title="All status problems heal when it switches out.">Natural Cure</span><br>2. <span class="tooltip" title="Contact with the Pokémon may poison the foe.">Poison Point</span><br>3. <span class="tooltip" title="Powers up the Pokémon’s weaker moves.">Technician</span> | #27 |
