...
|----------|------------|-----------------|-----------|-------------|------------|
| 1 Sp. Atk<br>1 Sp. Def | 75 | 70 | 158 | Medium | <span class="tooltip" title="An item to be held by a Pokémon. It is a shiny, silver powder that ups the power of Bug-type moves.">Silver Powder</span> (5%) |
