...
|-------|-------|------|-------|
| ![Dustox](../assets/sprites/dustox/front.gif "Dustox: It scatters its fine dust all over when it is attacked. It is a nocturnal Pokémon.") | ![Dustox](../assets/sprites/dustox/front_shiny.png "Dustox: It scatters its fine dust all over when it is attacked. It is a nocturnal Pokémon.") | ![Dustox](../assets/sprites/dustox/back.png "Dustox: It scatters its fine dust all over when it is attacked. It is a nocturnal Pokémon.") | ![Dustox](../assets/sprites/dustox/back_shiny.png "Dustox: It scatters its fine dust all over when it is attacked. It is a nocturnal Pokémon.") |

### Female Sprites

| Front | Shiny | Back | Shiny |
|-------|-------|------|-------|
| ![Dustox](../assets/sprites/dustox/front_female.gif "Dustox: It scatters its fine dust all over when it is attacked. It is a nocturnal Pokémon.") | ![Dustox](../assets/sprites/dustox/front_shiny_female.png "Dustox: It scatters its fine dust all over when it is attacked. It is a nocturnal Pokémon.") | ![Dustox](../assets/sprites/dustox/back_female.png "Dustox: It scatters its fine dust all over when it is attacked. It is a nocturnal Pokémon.") | ![Dustox](../assets/sprites/dustox/back_shiny_female.png "Dustox: It scatters its fine dust all over when it is attacked. It is a nocturnal Pokémon.") |
...
|---|----|--------|---------|---------|---------|-------|
| **Base** | 60 | 50 | 70 | 65 | 105 | 85 |
| **Min** | 230 | 94 | 130 | 121 | 193 | 157 |
| **Max** | 324 | 218 | 262 | 251 | 339 | 295 |
...
| 31 | <span class="tooltip" title="A wondrous wall of light is put up to suppress damage from physical attacks for five turns.">Reflect</span> | ![psychic](../assets/types/psychic.png "Psychic"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 20 |
...
| 44 | <span class="tooltip" title="The user whips up a turbulent whirlwind that ups the Speed of all party Pokémon for three turns.">Tailwind</span> | ![flying](../assets/types/flying.png "Flying"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 15 |
