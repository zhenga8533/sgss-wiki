...
|-------|-------|------|-------|
| ![Shuckle](../assets/sprites/shuckle/front.gif "Shuckle: It stores berries inside its shell. To avoid attacks, it hides beneath rocks and remains completely still.") | ![Shuckle](../assets/sprites/shuckle/front_shiny.png "Shuckle: It stores berries inside its shell. To avoid attacks, it hides beneath rocks and remains completely still.") | ![Shuckle](../assets/sprites/shuckle/back.png "Shuckle: It stores berries inside its shell. To avoid attacks, it hides beneath rocks and remains completely still.") | ![Shuckle](../assets/sprites/shuckle/back_shiny.png "Shuckle: It stores berries inside its shell. To avoid attacks, it hides beneath rocks and remains completely still.") |
...
| 9 | <span class="tooltip" title="The user compels the foe to keep using only the move it last used for three to seven turns.">Encore</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 100 | 5 |
...
| 48 | <span class="tooltip" title="The user employs its psychic power to switch its Attack with its Defense stat.">Power Trick</span> | ![psychic](../assets/types/psychic.png "Psychic"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 10 |
