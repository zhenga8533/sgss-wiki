...
**Sacred Gold:** It possesses strong spiritual power. The more danger it faces, the stronger its psychic power.

**Storm Silver:** If it uses its abilities, it emits special alpha waves that cause machines to malfunction.
...
|-------|-------|------|-------|
| ![Kadabra](../assets/sprites/kadabra/front.gif "Kadabra: If it uses its abilities, it emits special alpha waves that cause machines to malfunction.") | ![Kadabra](../assets/sprites/kadabra/front_shiny.png "Kadabra: If it uses its abilities, it emits special alpha waves that cause machines to malfunction.") | ![Kadabra](../assets/sprites/kadabra/back.png "Kadabra: If it uses its abilities, it emits special alpha waves that cause machines to malfunction.") | ![Kadabra](../assets/sprites/kadabra/back_shiny.png "Kadabra: If it uses its abilities, it emits special alpha waves that cause machines to malfunction.") |

### Female Sprites

| Front | Shiny | Back | Shiny |
|-------|-------|------|-------|
| ![Kadabra](../assets/sprites/kadabra/front_female.gif "Kadabra: If it uses its abilities, it emits special alpha waves that cause machines to malfunction.") | ![Kadabra](../assets/sprites/kadabra/front_shiny_female.png "Kadabra: If it uses its abilities, it emits special alpha waves that cause machines to malfunction.") | ![Kadabra](../assets/sprites/kadabra/back_female.png "Kadabra: If it uses its abilities, it emits special alpha waves that cause machines to malfunction.") | ![Kadabra](../assets/sprites/kadabra/back_shiny_female.png "Kadabra: If it uses its abilities, it emits special alpha waves that cause machines to malfunction.") |
...
|------------|---------|--------|--------|-----------|---------|
| #64 | ![psychic](../assets/types/psychic.png "Psychic"){: width="48"} | 1.3 m /<br>4.3 ft | 56.5 kg /<br>124.6 lbs | 1. <span class="tooltip" title="Passes a burn, poison, or paralysis to the foe.">Synchronize</span><br>2. <span class="tooltip" title="The Pokémon is protected from flinching.">Inner Focus</span><br>3. <span class="tooltip" title="The Pokémon only takes damage from attacks.">Magic Guard</span> | #21 |
