...
**Sacred Gold:** It flies straight at its target’s face, then clamps down on the startled victim to inject poison.

**Storm Silver:** It usually clings to cliffs. When it spots its prey, it spreads its wings and glides down to attack.
...
|-------|-------|------|-------|
| ![Gligar](../assets/sprites/gligar/front.gif "Gligar: It usually clings to cliffs. When it spots its prey, it spreads its wings and glides down to attack.") | ![Gligar](../assets/sprites/gligar/front_shiny.png "Gligar: It usually clings to cliffs. When it spots its prey, it spreads its wings and glides down to attack.") | ![Gligar](../assets/sprites/gligar/back.png "Gligar: It usually clings to cliffs. When it spots its prey, it spreads its wings and glides down to attack.") | ![Gligar](../assets/sprites/gligar/back_shiny.png "Gligar: It usually clings to cliffs. When it spots its prey, it spreads its wings and glides down to attack.") |

### Female Sprites

| Front | Shiny | Back | Shiny |
|-------|-------|------|-------|
| ![Gligar](../assets/sprites/gligar/front_female.gif "Gligar: It usually clings to cliffs. When it spots its prey, it spreads its wings and glides down to attack.") | ![Gligar](../assets/sprites/gligar/front_shiny_female.png "Gligar: It usually clings to cliffs. When it spots its prey, it spreads its wings and glides down to attack.") | ![Gligar](../assets/sprites/gligar/back_female.png "Gligar: It usually clings to cliffs. When it spots its prey, it spreads its wings and glides down to attack.") | ![Gligar](../assets/sprites/gligar/back_shiny_female.png "Gligar: It usually clings to cliffs. When it spots its prey, it spreads its wings and glides down to attack.") |
...
| <span class="tooltip" title="An attack with a high critical-hit ratio. This tail  attack may also  poison the foe.">Poison Tail</span> | ![poison](../assets/types/poison.png "Poison"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 50 | 100 | 25 |
...
| <span class="tooltip" title="A slashing attack that may also leave the target poisoned. It has a high critical-hit ratio.">Cross Poison</span> | ![poison](../assets/types/poison.png "Poison"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 70 | 100 | 20 |
