...
|-------|-------|------|-------|
| ![Scizor](../assets/sprites/scizor/front.gif "Scizor: Its wings are not used for flying. They are flapped at high speed to adjust its body temperature.") | ![Scizor](../assets/sprites/scizor/front_shiny.png "Scizor: Its wings are not used for flying. They are flapped at high speed to adjust its body temperature.") | ![Scizor](../assets/sprites/scizor/back.png "Scizor: Its wings are not used for flying. They are flapped at high speed to adjust its body temperature.") | ![Scizor](../assets/sprites/scizor/back_shiny.png "Scizor: Its wings are not used for flying. They are flapped at high speed to adjust its body temperature.") |

### Female Sprites

| Front | Shiny | Back | Shiny |
|-------|-------|------|-------|
| ![Scizor](../assets/sprites/scizor/front_female.gif "Scizor: Its wings are not used for flying. They are flapped at high speed to adjust its body temperature.") | ![Scizor](../assets/sprites/scizor/front_shiny_female.png "Scizor: Its wings are not used for flying. They are flapped at high speed to adjust its body temperature.") | N/A | N/A |
...
|------------|---------|--------|--------|-----------|---------|
| #212 | ![bug](../assets/types/bug.png "Bug"){: width="48"}<br>![steel](../assets/types/steel.png "Steel"){: width="48"} | 1.8 m /<br>5.9 ft | 118.0 kg /<br>260.1 lbs | 1. <span class="tooltip" title="Powers up Bug-type moves in a pinch.">Swarm</span><br>2. <span class="tooltip" title="Powers up the Pokémon’s weaker moves.">Technician</span><br>3. <span class="tooltip" title="This Pokémon has half the usual weight for its species.">Light Metal</span> | N/A |
