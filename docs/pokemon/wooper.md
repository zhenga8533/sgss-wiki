...
|-------|-------|------|-------|
| ![Wooper](../assets/sprites/wooper/front.gif "Wooper: When it walks around on the ground, it coats its body with a slimy, poisonous film.") | ![Wooper](../assets/sprites/wooper/front_shiny.png "Wooper: When it walks around on the ground, it coats its body with a slimy, poisonous film.") | ![Wooper](../assets/sprites/wooper/back.png "Wooper: When it walks around on the ground, it coats its body with a slimy, poisonous film.") | ![Wooper](../assets/sprites/wooper/back_shiny.png "Wooper: When it walks around on the ground, it coats its body with a slimy, poisonous film.") |

### Female Sprites

| Front | Shiny | Back | Shiny |
|-------|-------|------|-------|
| ![Wooper](../assets/sprites/wooper/front_female.gif "Wooper: When it walks around on the ground, it coats its body with a slimy, poisonous film.") | ![Wooper](../assets/sprites/wooper/front_shiny_female.png "Wooper: When it walks around on the ground, it coats its body with a slimy, poisonous film.") | ![Wooper](../assets/sprites/wooper/back_female.png "Wooper: When it walks around on the ground, it coats its body with a slimy, poisonous film.") | ![Wooper](../assets/sprites/wooper/back_shiny_female.png "Wooper: When it walks around on the ground, it coats its body with a slimy, poisonous film.") |
...
|------------|---------|--------|--------|-----------|---------|
| #194 | ![water](../assets/types/water.png "Water"){: width="48"}<br>![ground](../assets/types/ground.png "Ground"){: width="48"} | 0.4 m /<br>1.3 ft | 8.5 kg /<br>18.7 lbs | 1. <span class="tooltip" title="Prevents combatants from self-destructing.">Damp</span><br>2. <span class="tooltip" title="Restores HP if hit by a Water-type move.">Water Absorb</span><br>3. <span class="tooltip" title="Ignores any change in ability by the foe.">Unaware</span> | #117 |
