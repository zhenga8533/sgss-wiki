...
|-------|-------|------|-------|
| ![Sunflora](../assets/sprites/sunflora/front.gif "Sunflora: In the daytime, it rushes about in a hectic manner, but it comes to a complete stop when the sun sets.") | ![Sunflora](../assets/sprites/sunflora/front_shiny.png "Sunflora: In the daytime, it rushes about in a hectic manner, but it comes to a complete stop when the sun sets.") | ![Sunflora](../assets/sprites/sunflora/back.png "Sunflora: In the daytime, it rushes about in a hectic manner, but it comes to a complete stop when the sun sets.") | ![Sunflora](../assets/sprites/sunflora/back_shiny.png "Sunflora: In the daytime, it rushes about in a hectic manner, but it comes to a complete stop when the sun sets.") |
...
|----------|------------|-----------------|-----------|-------------|------------|
| 2 Sp. Atk | 120 | 70 | 196 | Medium Slow | N/A |
...
| 21 | <span class="tooltip" title="The user forcefully shoots seeds at the foe. Two to five seeds are shot in rapid succession.">Bullet Seed</span> | ![grass](../assets/types/grass.png "Grass"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 25 | 100 | 30 |
