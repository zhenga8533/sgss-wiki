...
**Sacred Gold:** Because its wings aren’t yet fully grown, it has to hop to get around. It is always staring at something.

**Storm Silver:** It usually forages for food on the ground but may, on rare occasions, hop onto branches to peck at shoots.
...
|-------|-------|------|-------|
| ![Natu](../assets/sprites/natu/front.gif "Natu: It usually forages for food on the ground but may, on rare occasions, hop onto branches to peck at shoots.") | ![Natu](../assets/sprites/natu/front_shiny.png "Natu: It usually forages for food on the ground but may, on rare occasions, hop onto branches to peck at shoots.") | ![Natu](../assets/sprites/natu/back.png "Natu: It usually forages for food on the ground but may, on rare occasions, hop onto branches to peck at shoots.") | ![Natu](../assets/sprites/natu/back_shiny.png "Natu: It usually forages for food on the ground but may, on rare occasions, hop onto branches to peck at shoots.") |
...
|------------|---------|--------|--------|-----------|---------|
| #177 | ![psychic](../assets/types/psychic.png "Psychic"){: width="48"}<br>![flying](../assets/types/flying.png "Flying"){: width="48"} | 0.2 m /<br>0.7 ft | 2.0 kg /<br>4.4 lbs | 1. <span class="tooltip" title="Passes a burn, poison, or paralysis to the foe.">Synchronize</span><br>2. <span class="tooltip" title="The Pokémon awakens quickly from sleep.">Early Bird</span><br>3. <span class="tooltip" title="When this Pokémon is targeted by a move flagged as being reflectable, the move is redirected to its user.  All reflectable moves are non-damaging, and most non-damaging moves that target other Pokémon are reflectable.  A move reflected by this ability or magic coat cannot be reflected back.">Magic Bounce</span> | N/A |
...
| 39 | <span class="tooltip" title="The user creates a gust of repulsive wind. It may also raise all the user’s stats at once.">Ominous Wind</span> | ![ghost](../assets/types/ghost.png "Ghost"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 60 | 100 | 5 |
| 44 | <span class="tooltip" title="The user employs its psychic power to switch changes to its Defense and Sp. Def with the foe.">Guard Swap</span> | ![psychic](../assets/types/psychic.png "Psychic"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 10 |
