...
|-------|-------|------|-------|
| ![Ledyba](../assets/sprites/ledyba/front.gif "Ledyba: When the weather turns cold, lots of LEDYBA gather from everywhere to cluster and keep each other warm.") | ![Ledyba](../assets/sprites/ledyba/front_shiny.png "Ledyba: When the weather turns cold, lots of LEDYBA gather from everywhere to cluster and keep each other warm.") | ![Ledyba](../assets/sprites/ledyba/back.png "Ledyba: When the weather turns cold, lots of LEDYBA gather from everywhere to cluster and keep each other warm.") | ![Ledyba](../assets/sprites/ledyba/back_shiny.png "Ledyba: When the weather turns cold, lots of LEDYBA gather from everywhere to cluster and keep each other warm.") |

### Female Sprites

| Front | Shiny | Back | Shiny |
|-------|-------|------|-------|
| ![Ledyba](../assets/sprites/ledyba/front_female.gif "Ledyba: When the weather turns cold, lots of LEDYBA gather from everywhere to cluster and keep each other warm.") | ![Ledyba](../assets/sprites/ledyba/front_shiny_female.png "Ledyba: When the weather turns cold, lots of LEDYBA gather from everywhere to cluster and keep each other warm.") | ![Ledyba](../assets/sprites/ledyba/back_female.png "Ledyba: When the weather turns cold, lots of LEDYBA gather from everywhere to cluster and keep each other warm.") | ![Ledyba](../assets/sprites/ledyba/back_shiny_female.png "Ledyba: When the weather turns cold, lots of LEDYBA gather from everywhere to cluster and keep each other warm.") |
...
|------------|---------|--------|--------|-----------|---------|
| #165 | ![bug](../assets/types/bug.png "Bug"){: width="48"}<br>![flying](../assets/types/flying.png "Flying"){: width="48"} | 1.0 m /<br>3.3 ft | 10.8 kg /<br>23.8 lbs | 1. <span class="tooltip" title="Powers up Bug-type moves in a pinch.">Swarm</span><br>2. <span class="tooltip" title="The Pokémon awakens quickly from sleep.">Early Bird</span><br>3. <span class="tooltip" title="This Pokémon's Speed rises one stage with each hit from a damaging dark-, ghost-, or bug-type move.">Rattled</span> | N/A |
