...
|-------|-------|------|-------|
| ![Delcatty](../assets/sprites/delcatty/front.gif "Delcatty: It dislikes dirty places. It often searches for a comfortable place in which to groom itself.") | ![Delcatty](../assets/sprites/delcatty/front_shiny.png "Delcatty: It dislikes dirty places. It often searches for a comfortable place in which to groom itself.") | ![Delcatty](../assets/sprites/delcatty/back.png "Delcatty: It dislikes dirty places. It often searches for a comfortable place in which to groom itself.") | ![Delcatty](../assets/sprites/delcatty/back_shiny.png "Delcatty: It dislikes dirty places. It often searches for a comfortable place in which to groom itself.") |
...
|----------|------------|-----------------|-----------|-------------|------------|
| 1 Hp<br>1 Speed | 60 | 70 | 140 | Fast | <span class="tooltip" title="It may be used or held by a Pokémon to restore a move’s PP by 10.">Leppa Berry</span> (5%) |
