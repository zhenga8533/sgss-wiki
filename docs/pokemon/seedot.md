...
|-------|-------|------|-------|
| ![Seedot](../assets/sprites/seedot/front.gif "Seedot: It attaches itself to a tree branch using the top of its head. Strong winds can sometimes make it fall.") | ![Seedot](../assets/sprites/seedot/front_shiny.png "Seedot: It attaches itself to a tree branch using the top of its head. Strong winds can sometimes make it fall.") | ![Seedot](../assets/sprites/seedot/back.png "Seedot: It attaches itself to a tree branch using the top of its head. Strong winds can sometimes make it fall.") | ![Seedot](../assets/sprites/seedot/back_shiny.png "Seedot: It attaches itself to a tree branch using the top of its head. Strong winds can sometimes make it fall.") |
