...
|-------|-------|------|-------|
| ![Snover](../assets/sprites/snover/front.gif "Snover: During cold seasons, it migrates to the mountain’s lower reaches. It returns to the snow-covered summit in the spring.") | ![Snover](../assets/sprites/snover/front_shiny.png "Snover: During cold seasons, it migrates to the mountain’s lower reaches. It returns to the snow-covered summit in the spring.") | ![Snover](../assets/sprites/snover/back.png "Snover: During cold seasons, it migrates to the mountain’s lower reaches. It returns to the snow-covered summit in the spring.") | ![Snover](../assets/sprites/snover/back_shiny.png "Snover: During cold seasons, it migrates to the mountain’s lower reaches. It returns to the snow-covered summit in the spring.") |

### Female Sprites

| Front | Shiny | Back | Shiny |
|-------|-------|------|-------|
| ![Snover](../assets/sprites/snover/front_female.gif "Snover: During cold seasons, it migrates to the mountain’s lower reaches. It returns to the snow-covered summit in the spring.") | ![Snover](../assets/sprites/snover/front_shiny_female.png "Snover: During cold seasons, it migrates to the mountain’s lower reaches. It returns to the snow-covered summit in the spring.") | ![Snover](../assets/sprites/snover/back_female.png "Snover: During cold seasons, it migrates to the mountain’s lower reaches. It returns to the snow-covered summit in the spring.") | ![Snover](../assets/sprites/snover/back_shiny_female.png "Snover: During cold seasons, it migrates to the mountain’s lower reaches. It returns to the snow-covered summit in the spring.") |
