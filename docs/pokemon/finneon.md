...
|-------|-------|------|-------|
| ![Finneon](../assets/sprites/finneon/front.gif "Finneon: Swimming and fluttering its two tail fins, it looks like a BEAUTIFLY. At night, the patterns on its tail fins softly shine.") | ![Finneon](../assets/sprites/finneon/front_shiny.png "Finneon: Swimming and fluttering its two tail fins, it looks like a BEAUTIFLY. At night, the patterns on its tail fins softly shine.") | ![Finneon](../assets/sprites/finneon/back.png "Finneon: Swimming and fluttering its two tail fins, it looks like a BEAUTIFLY. At night, the patterns on its tail fins softly shine.") | ![Finneon](../assets/sprites/finneon/back_shiny.png "Finneon: Swimming and fluttering its two tail fins, it looks like a BEAUTIFLY. At night, the patterns on its tail fins softly shine.") |

### Female Sprites

| Front | Shiny | Back | Shiny |
|-------|-------|------|-------|
| ![Finneon](../assets/sprites/finneon/front_female.gif "Finneon: Swimming and fluttering its two tail fins, it looks like a BEAUTIFLY. At night, the patterns on its tail fins softly shine.") | ![Finneon](../assets/sprites/finneon/front_shiny_female.png "Finneon: Swimming and fluttering its two tail fins, it looks like a BEAUTIFLY. At night, the patterns on its tail fins softly shine.") | ![Finneon](../assets/sprites/finneon/back_female.png "Finneon: Swimming and fluttering its two tail fins, it looks like a BEAUTIFLY. At night, the patterns on its tail fins softly shine.") | ![Finneon](../assets/sprites/finneon/back_shiny_female.png "Finneon: Swimming and fluttering its two tail fins, it looks like a BEAUTIFLY. At night, the patterns on its tail fins softly shine.") |
...
|----------|------------|-----------------|-----------|-------------|------------|
| 1 Speed | 190 | 70 | 66 | Slow Then Very Fast | <span class="tooltip" title="If held by a Pokémon, it weakens a foe’s supereffective Grass-type attack.">Rindo Berry</span> (5%) |
...
| 38 | <span class="tooltip" title="Traps the foe inside a whirlpool that lasts for two to five turns. The user can pass through whirlpools.">Whirlpool</span> | ![water](../assets/types/water.png "Water"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 35 | 85 | 15 |
...
| <span class="tooltip" title="The foe is hit with a rainbow-colored beam. It may also lower the target’s Attack stat.">Aurora Beam</span> | ![ice](../assets/types/ice.png "Ice"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 65 | 100 | 20 |
