...
|-------|-------|------|-------|
| ![Larvitar](../assets/sprites/larvitar/front.gif "Larvitar: It is born deep underground. It can’t emerge until it has entirely consumed the soil around it.") | ![Larvitar](../assets/sprites/larvitar/front_shiny.png "Larvitar: It is born deep underground. It can’t emerge until it has entirely consumed the soil around it.") | ![Larvitar](../assets/sprites/larvitar/back.png "Larvitar: It is born deep underground. It can’t emerge until it has entirely consumed the soil around it.") | ![Larvitar](../assets/sprites/larvitar/back_shiny.png "Larvitar: It is born deep underground. It can’t emerge until it has entirely consumed the soil around it.") |
...
|------------|---------|--------|--------|-----------|---------|
| #246 | ![rock](../assets/types/rock.png "Rock"){: width="48"}<br>![ground](../assets/types/ground.png "Ground"){: width="48"} | 0.6 m /<br>2.0 ft | 72.0 kg /<br>158.7 lbs | 1. <span class="tooltip" title="Boosts Attack if there is a status problem.">Guts</span><br>2. <span class="tooltip" title="The Pokémon is protected against critical hits.">Battle Armor</span> | N/A |
...
| 32 | <span class="tooltip" title="The user releases a horrible aura imbued with dark thoughts. It may also make the target flinch.">Dark Pulse</span> | ![dark](../assets/types/dark.png "Dark"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 80 | 100 | 15 |
