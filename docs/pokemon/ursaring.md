...
|-------|-------|------|-------|
| ![Ursaring](../assets/sprites/ursaring/front.gif "Ursaring: With its ability to distinguish any aroma, it unfailingly finds all food buried deep underground.") | ![Ursaring](../assets/sprites/ursaring/front_shiny.png "Ursaring: With its ability to distinguish any aroma, it unfailingly finds all food buried deep underground.") | ![Ursaring](../assets/sprites/ursaring/back.png "Ursaring: With its ability to distinguish any aroma, it unfailingly finds all food buried deep underground.") | ![Ursaring](../assets/sprites/ursaring/back_shiny.png "Ursaring: With its ability to distinguish any aroma, it unfailingly finds all food buried deep underground.") |

### Female Sprites

| Front | Shiny | Back | Shiny |
|-------|-------|------|-------|
| ![Ursaring](../assets/sprites/ursaring/front_female.gif "Ursaring: With its ability to distinguish any aroma, it unfailingly finds all food buried deep underground.") | ![Ursaring](../assets/sprites/ursaring/front_shiny_female.png "Ursaring: With its ability to distinguish any aroma, it unfailingly finds all food buried deep underground.") | ![Ursaring](../assets/sprites/ursaring/back_female.png "Ursaring: With its ability to distinguish any aroma, it unfailingly finds all food buried deep underground.") | ![Ursaring](../assets/sprites/ursaring/back_shiny_female.png "Ursaring: With its ability to distinguish any aroma, it unfailingly finds all food buried deep underground.") |
...
| 76 | <span class="tooltip" title="The user fights the foe up close without guarding itself. It also cuts the user’s Defense and Sp. Def.">Close Combat</span> | ![fighting](../assets/types/fighting.png "Fighting"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 120 | 100 | 5 |
