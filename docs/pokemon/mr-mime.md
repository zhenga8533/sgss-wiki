...
**Sacred Gold:** A skilled mime from birth, it gains the ability to create invisible objects as it matures.

**Storm Silver:** Its fingertips emit a peculiar force field that hardens air to create an actual wall.
...
|-------|-------|------|-------|
| ![Mr Mime](../assets/sprites/mr-mime/front.gif "Mr Mime: Its fingertips emit a peculiar force field that hardens air to create an actual wall.") | ![Mr Mime](../assets/sprites/mr-mime/front_shiny.png "Mr Mime: Its fingertips emit a peculiar force field that hardens air to create an actual wall.") | ![Mr Mime](../assets/sprites/mr-mime/back.png "Mr Mime: Its fingertips emit a peculiar force field that hardens air to create an actual wall.") | ![Mr Mime](../assets/sprites/mr-mime/back_shiny.png "Mr Mime: Its fingertips emit a peculiar force field that hardens air to create an actual wall.") |
...
|----------|------------|-----------------|-----------|-------------|------------|
| 2 Special Defense | 45 | 50 | 161 | Medium | <span class="tooltip" title="It may be used or held by a Pokémon to restore a move’s PP by 10.">Leppa Berry</span> (5%) |
