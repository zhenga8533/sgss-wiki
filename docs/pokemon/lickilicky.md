...
|-------|-------|------|-------|
| ![Lickilicky](../assets/sprites/lickilicky/front.gif "Lickilicky: It has space in its throat to store saliva. It can also roll up its tongue and store it in the same spot.") | ![Lickilicky](../assets/sprites/lickilicky/front_shiny.png "Lickilicky: It has space in its throat to store saliva. It can also roll up its tongue and store it in the same spot.") | ![Lickilicky](../assets/sprites/lickilicky/back.png "Lickilicky: It has space in its throat to store saliva. It can also roll up its tongue and store it in the same spot.") | ![Lickilicky](../assets/sprites/lickilicky/back_shiny.png "Lickilicky: It has space in its throat to store saliva. It can also roll up its tongue and store it in the same spot.") |
