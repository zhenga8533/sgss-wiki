...
|-------|-------|------|-------|
| ![Poliwrath](../assets/sprites/poliwrath/front.gif "Poliwrath: Although an energetic, skilled swimmer that uses all of its muscles, it lives on dry land.") | ![Poliwrath](../assets/sprites/poliwrath/front_shiny.png "Poliwrath: Although an energetic, skilled swimmer that uses all of its muscles, it lives on dry land.") | ![Poliwrath](../assets/sprites/poliwrath/back.png "Poliwrath: Although an energetic, skilled swimmer that uses all of its muscles, it lives on dry land.") | ![Poliwrath](../assets/sprites/poliwrath/back_shiny.png "Poliwrath: Although an energetic, skilled swimmer that uses all of its muscles, it lives on dry land.") |
...
| 1 | <span class="tooltip" title="The user grabs the foe and recklessly dives for the ground. It also hurts the user slightly.">Submission</span> | ![fighting](../assets/types/fighting.png "Fighting"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 80 | 80 | 20 |
| 23 | <span class="tooltip" title="The foe is punched with an icy fist. It may leave the target frozen. ">Ice Punch</span> | ![ice](../assets/types/ice.png "Ice"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 75 | 100 | 15 |
...
| 63 | <span class="tooltip" title="The user fights the foe up close without guarding itself. It also cuts the user’s Defense and Sp. Def.">Close Combat</span> | ![fighting](../assets/types/fighting.png "Fighting"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 120 | 100 | 5 |
