...
|-------|-------|------|-------|
| ![Garchomp](../assets/sprites/garchomp/front.gif "Garchomp: Its body is covered in fine scales that reduce drag, enabling it to fly at high speeds.") | ![Garchomp](../assets/sprites/garchomp/front_shiny.png "Garchomp: Its body is covered in fine scales that reduce drag, enabling it to fly at high speeds.") | ![Garchomp](../assets/sprites/garchomp/back.png "Garchomp: Its body is covered in fine scales that reduce drag, enabling it to fly at high speeds.") | ![Garchomp](../assets/sprites/garchomp/back_shiny.png "Garchomp: Its body is covered in fine scales that reduce drag, enabling it to fly at high speeds.") |

### Female Sprites

| Front | Shiny | Back | Shiny |
|-------|-------|------|-------|
| ![Garchomp](../assets/sprites/garchomp/front_female.gif "Garchomp: Its body is covered in fine scales that reduce drag, enabling it to fly at high speeds.") | ![Garchomp](../assets/sprites/garchomp/front_shiny_female.png "Garchomp: Its body is covered in fine scales that reduce drag, enabling it to fly at high speeds.") | N/A | N/A |
