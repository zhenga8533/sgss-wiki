...
|-------|-------|------|-------|
| ![Oddish](../assets/sprites/oddish/front.gif "Oddish: If exposed to moonlight, it starts to move. It roams far and wide at night to scatter its seeds.") | ![Oddish](../assets/sprites/oddish/front_shiny.png "Oddish: If exposed to moonlight, it starts to move. It roams far and wide at night to scatter its seeds.") | ![Oddish](../assets/sprites/oddish/back.png "Oddish: If exposed to moonlight, it starts to move. It roams far and wide at night to scatter its seeds.") | ![Oddish](../assets/sprites/oddish/back_shiny.png "Oddish: If exposed to moonlight, it starts to move. It roams far and wide at night to scatter its seeds.") |
...
| 45 | <span class="tooltip" title="The user performs a wobbly dance that confuses all the Pokémon in battle. ">Teeter Dance</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 100 | 20 |
