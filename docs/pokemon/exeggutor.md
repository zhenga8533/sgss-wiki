...
|-------|-------|------|-------|
| ![Exeggutor](../assets/sprites/exeggutor/front.gif "Exeggutor: If a head drops off, it emits a telepathic call in search of others to form an EXEGGCUTE cluster.") | ![Exeggutor](../assets/sprites/exeggutor/front_shiny.png "Exeggutor: If a head drops off, it emits a telepathic call in search of others to form an EXEGGCUTE cluster.") | ![Exeggutor](../assets/sprites/exeggutor/back.png "Exeggutor: If a head drops off, it emits a telepathic call in search of others to form an EXEGGCUTE cluster.") | ![Exeggutor](../assets/sprites/exeggutor/back_shiny.png "Exeggutor: If a head drops off, it emits a telepathic call in search of others to form an EXEGGCUTE cluster.") |
...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | <span class="tooltip" title="Round objects are hurled at the foe to strike two to five times in a row. ">Barrage</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 15 | 85 | 20 |
...
| 57 | <span class="tooltip" title="An attack that makes use of nature’s power. Its effects vary depending on the user’s environment.">Nature Power</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 20 |
