...
**Sacred Gold:** They love to gather in smelly areas where sludge accumulates, making the stench around them worse.

**Storm Silver:** Its body is made of a powerful poison. Touching it accidentally will cause a fever that requires bed rest.
...
|-------|-------|------|-------|
| ![Muk](../assets/sprites/muk/front.gif "Muk: Its body is made of a powerful poison. Touching it accidentally will cause a fever that requires bed rest.") | ![Muk](../assets/sprites/muk/front_shiny.png "Muk: Its body is made of a powerful poison. Touching it accidentally will cause a fever that requires bed rest.") | ![Muk](../assets/sprites/muk/back.png "Muk: Its body is made of a powerful poison. Touching it accidentally will cause a fever that requires bed rest.") | ![Muk](../assets/sprites/muk/back_shiny.png "Muk: Its body is made of a powerful poison. Touching it accidentally will cause a fever that requires bed rest.") |
...
|----------|------------|-----------------|-----------|-------------|------------|
| 1 None<br>1 Atk | 75 | 70 | 175 | Medium | <span class="tooltip" title="A nugget of pure gold that gives off a lustrous gleam. It can be sold at a high price to shops.">Nugget</span> (5%) |
...
| 20 | <span class="tooltip" title="Unsanitary sludge is hurled at the foe. It may also poison the target. ">Sludge</span> | ![poison](../assets/types/poison.png "Poison"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 65 | 100 | 20 |
...
| 38 | <span class="tooltip" title="The user throws a punch at the foe from the shadows. The punch lands without fail.">Shadow Punch</span> | ![ghost](../assets/types/ghost.png "Ghost"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 60 | — | 20 |
...
| 75 | <span class="tooltip" title="A move that works differently for the Ghost type than for all the other types. ">Curse</span> | ![ghost](../assets/types/ghost.png "Ghost"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 10 |
