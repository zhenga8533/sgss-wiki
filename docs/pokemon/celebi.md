...
|-------|-------|------|-------|
| ![Celebi](../assets/sprites/celebi/front.gif "Celebi: When CELEBI disappears deep in a forest, it is said to leave behind an egg it brought from the future.") | ![Celebi](../assets/sprites/celebi/front_shiny.png "Celebi: When CELEBI disappears deep in a forest, it is said to leave behind an egg it brought from the future.") | ![Celebi](../assets/sprites/celebi/back.png "Celebi: When CELEBI disappears deep in a forest, it is said to leave behind an egg it brought from the future.") | ![Celebi](../assets/sprites/celebi/back_shiny.png "Celebi: When CELEBI disappears deep in a forest, it is said to leave behind an egg it brought from the future.") |
...
| 100 | <span class="tooltip" title="The user stimulates its brain by thinking bad thoughts. It sharply raises the user’s Sp. Atk.">Nasty Plot</span> | ![dark](../assets/types/dark.png "Dark"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 20 |
