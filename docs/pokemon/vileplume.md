...
**Sacred Gold:** It has the world’s largest petals. With every step, the petals shake out heavy clouds of toxic pollen.

**Storm Silver:** The bud bursts into bloom with a bang. It then starts scattering allergenic, poisonous pollen.
...
|-------|-------|------|-------|
| ![Vileplume](../assets/sprites/vileplume/front.gif "Vileplume: The bud bursts into bloom with a bang. It then starts scattering allergenic, poisonous pollen.") | ![Vileplume](../assets/sprites/vileplume/front_shiny.png "Vileplume: The bud bursts into bloom with a bang. It then starts scattering allergenic, poisonous pollen.") | ![Vileplume](../assets/sprites/vileplume/back.png "Vileplume: The bud bursts into bloom with a bang. It then starts scattering allergenic, poisonous pollen.") | ![Vileplume](../assets/sprites/vileplume/back_shiny.png "Vileplume: The bud bursts into bloom with a bang. It then starts scattering allergenic, poisonous pollen.") |

### Female Sprites

| Front | Shiny | Back | Shiny |
|-------|-------|------|-------|
| ![Vileplume](../assets/sprites/vileplume/front_female.gif "Vileplume: The bud bursts into bloom with a bang. It then starts scattering allergenic, poisonous pollen.") | ![Vileplume](../assets/sprites/vileplume/front_shiny_female.png "Vileplume: The bud bursts into bloom with a bang. It then starts scattering allergenic, poisonous pollen.") | ![Vileplume](../assets/sprites/vileplume/back_female.png "Vileplume: The bud bursts into bloom with a bang. It then starts scattering allergenic, poisonous pollen.") | ![Vileplume](../assets/sprites/vileplume/back_shiny_female.png "Vileplume: The bud bursts into bloom with a bang. It then starts scattering allergenic, poisonous pollen.") |
...
|---|----|--------|---------|---------|---------|-------|
| **Base** | 75 | 80 | 85 | 110 | 100 | 50 |
| **Min** | 260 | 148 | 157 | 202 | 184 | 94 |
| **Max** | 354 | 284 | 295 | 350 | 328 | 218 |
