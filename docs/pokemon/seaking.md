...
|-------|-------|------|-------|
| ![Seaking](../assets/sprites/seaking/front.gif "Seaking: Using its horn, it bores holes in riverbed boulders, making nests to prevent its eggs from washing away.") | ![Seaking](../assets/sprites/seaking/front_shiny.png "Seaking: Using its horn, it bores holes in riverbed boulders, making nests to prevent its eggs from washing away.") | ![Seaking](../assets/sprites/seaking/back.png "Seaking: Using its horn, it bores holes in riverbed boulders, making nests to prevent its eggs from washing away.") | ![Seaking](../assets/sprites/seaking/back_shiny.png "Seaking: Using its horn, it bores holes in riverbed boulders, making nests to prevent its eggs from washing away.") |

### Female Sprites

| Front | Shiny | Back | Shiny |
|-------|-------|------|-------|
| ![Seaking](../assets/sprites/seaking/front_female.gif "Seaking: Using its horn, it bores holes in riverbed boulders, making nests to prevent its eggs from washing away.") | ![Seaking](../assets/sprites/seaking/front_shiny_female.png "Seaking: Using its horn, it bores holes in riverbed boulders, making nests to prevent its eggs from washing away.") | ![Seaking](../assets/sprites/seaking/back_female.png "Seaking: Using its horn, it bores holes in riverbed boulders, making nests to prevent its eggs from washing away.") | ![Seaking](../assets/sprites/seaking/back_shiny_female.png "Seaking: Using its horn, it bores holes in riverbed boulders, making nests to prevent its eggs from washing away.") |
...
| 40 | <span class="tooltip" title="The user charges at the foe rapidly, and may make it flinch. It can also be used to climb a waterfall.">Waterfall</span> | ![water](../assets/types/water.png "Water"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 80 | 100 | 15 |
| 47 | <span class="tooltip" title="The foe is stabbed with a horn rotating like a drill. The foe instantly faints if it hits.">Horn Drill</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | — | 30 | 5 |
...
| 72 | <span class="tooltip" title="Using its tough and impressive horn, the user rams into the foe  with no letup. ">Megahorn</span> | ![bug](../assets/types/bug.png "Bug"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 120 | 85 | 10 |
