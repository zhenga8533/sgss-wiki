...
|-------|-------|------|-------|
| ![Shedinja](../assets/sprites/shedinja/front.gif "Shedinja: A strange Pokémon--it flies without moving its wings, has a hollow shell for a body, and does not breathe.") | ![Shedinja](../assets/sprites/shedinja/front_shiny.png "Shedinja: A strange Pokémon--it flies without moving its wings, has a hollow shell for a body, and does not breathe.") | ![Shedinja](../assets/sprites/shedinja/back.png "Shedinja: A strange Pokémon--it flies without moving its wings, has a hollow shell for a body, and does not breathe.") | ![Shedinja](../assets/sprites/shedinja/back_shiny.png "Shedinja: A strange Pokémon--it flies without moving its wings, has a hollow shell for a body, and does not breathe.") |
...
| 59 | <span class="tooltip" title="The user hurls a shadowy blob at the foe. It may also lower the foe’s Sp. Def stat.">Shadow Ball</span> | ![ghost](../assets/types/ghost.png "Ghost"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 80 | 100 | 15 |
