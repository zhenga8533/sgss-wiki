...
|-------|-------|------|-------|
| ![Hypno](../assets/sprites/hypno/front.gif "Hypno: Always holding a pendulum that it swings at a steady rhythm, it causes drowsiness in anyone nearby.") | ![Hypno](../assets/sprites/hypno/front_shiny.png "Hypno: Always holding a pendulum that it swings at a steady rhythm, it causes drowsiness in anyone nearby.") | ![Hypno](../assets/sprites/hypno/back.png "Hypno: Always holding a pendulum that it swings at a steady rhythm, it causes drowsiness in anyone nearby.") | ![Hypno](../assets/sprites/hypno/back_shiny.png "Hypno: Always holding a pendulum that it swings at a steady rhythm, it causes drowsiness in anyone nearby.") |

### Female Sprites

| Front | Shiny | Back | Shiny |
|-------|-------|------|-------|
| ![Hypno](../assets/sprites/hypno/front_female.gif "Hypno: Always holding a pendulum that it swings at a steady rhythm, it causes drowsiness in anyone nearby.") | ![Hypno](../assets/sprites/hypno/front_shiny_female.png "Hypno: Always holding a pendulum that it swings at a steady rhythm, it causes drowsiness in anyone nearby.") | ![Hypno](../assets/sprites/hypno/back_female.png "Hypno: Always holding a pendulum that it swings at a steady rhythm, it causes drowsiness in anyone nearby.") | ![Hypno](../assets/sprites/hypno/back_shiny_female.png "Hypno: Always holding a pendulum that it swings at a steady rhythm, it causes drowsiness in anyone nearby.") |
...
| 13 | <span class="tooltip" title="The user attacks with its head. It may make the foe flinch. To find Pokémon, hit trees.">Headbutt</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 70 | 100 | 15 |
...
| 29 | <span class="tooltip" title="The user attacks with its head. It may make the foe flinch. To find Pokémon, hit trees.">Headbutt</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 70 | 100 | 15 |
