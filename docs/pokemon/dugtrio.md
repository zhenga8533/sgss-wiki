...
**Sacred Gold:** Its three heads bob separately up and down to loosen the soil nearby, making it easier for it to burrow.

**Storm Silver:** Extremely powerful, they can dig through even the hardest ground to a depth of over 60 miles.
...
|-------|-------|------|-------|
| ![Dugtrio](../assets/sprites/dugtrio/front.gif "Dugtrio: Extremely powerful, they can dig through even the hardest ground to a depth of over 60 miles.") | ![Dugtrio](../assets/sprites/dugtrio/front_shiny.png "Dugtrio: Extremely powerful, they can dig through even the hardest ground to a depth of over 60 miles.") | ![Dugtrio](../assets/sprites/dugtrio/back.png "Dugtrio: Extremely powerful, they can dig through even the hardest ground to a depth of over 60 miles.") | ![Dugtrio](../assets/sprites/dugtrio/back_shiny.png "Dugtrio: Extremely powerful, they can dig through even the hardest ground to a depth of over 60 miles.") |
...
| 18 | <span class="tooltip" title="The user burrows, then attacks on the second turn. It can also be used to exit dungeons.">Dig</span> | ![ground](../assets/types/ground.png "Ground"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 80 | 100 | 10 |
...
| 26 | <span class="tooltip" title="The user traps the foe inside a harshly raging sandstorm for two to five turns. ">Sand Tomb</span> | ![ground](../assets/types/ground.png "Ground"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 35 | 85 | 15 |
