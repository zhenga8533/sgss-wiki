...
|-------|-------|------|-------|
| ![Golbat](../assets/sprites/golbat/front.gif "Golbat: It can drink more than 10 ounces of blood at once. If it has too much, it gets heavy and flies clumsily.") | ![Golbat](../assets/sprites/golbat/front_shiny.png "Golbat: It can drink more than 10 ounces of blood at once. If it has too much, it gets heavy and flies clumsily.") | ![Golbat](../assets/sprites/golbat/back.png "Golbat: It can drink more than 10 ounces of blood at once. If it has too much, it gets heavy and flies clumsily.") | ![Golbat](../assets/sprites/golbat/back_shiny.png "Golbat: It can drink more than 10 ounces of blood at once. If it has too much, it gets heavy and flies clumsily.") |

### Female Sprites

| Front | Shiny | Back | Shiny |
|-------|-------|------|-------|
| ![Golbat](../assets/sprites/golbat/front_female.gif "Golbat: It can drink more than 10 ounces of blood at once. If it has too much, it gets heavy and flies clumsily.") | ![Golbat](../assets/sprites/golbat/front_shiny_female.png "Golbat: It can drink more than 10 ounces of blood at once. If it has too much, it gets heavy and flies clumsily.") | ![Golbat](../assets/sprites/golbat/back_female.png "Golbat: It can drink more than 10 ounces of blood at once. If it has too much, it gets heavy and flies clumsily.") | ![Golbat](../assets/sprites/golbat/back_shiny_female.png "Golbat: It can drink more than 10 ounces of blood at once. If it has too much, it gets heavy and flies clumsily.") |
...
|------------|---------|--------|--------|-----------|---------|
| #42 | ![poison](../assets/types/poison.png "Poison"){: width="48"}<br>![flying](../assets/types/flying.png "Flying"){: width="48"} | 1.6 m /<br>5.2 ft | 55.0 kg /<br>121.3 lbs | 1. <span class="tooltip" title="The Pokémon is protected from flinching.">Inner Focus</span><br>2. <span class="tooltip" title="Senses the foe’s dangerous moves.">Anticipation</span> | #29 |
