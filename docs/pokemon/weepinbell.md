...
**Sacred Gold:** Even though it is filled with acid, it does not melt because it also oozes a protective fluid.

**Storm Silver:** If its prey is bigger than its mouth, it slices up the victim with sharp leaves, then eats every morsel.
...
|-------|-------|------|-------|
| ![Weepinbell](../assets/sprites/weepinbell/front.gif "Weepinbell: If its prey is bigger than its mouth, it slices up the victim with sharp leaves, then eats every morsel.") | ![Weepinbell](../assets/sprites/weepinbell/front_shiny.png "Weepinbell: If its prey is bigger than its mouth, it slices up the victim with sharp leaves, then eats every morsel.") | ![Weepinbell](../assets/sprites/weepinbell/back.png "Weepinbell: If its prey is bigger than its mouth, it slices up the victim with sharp leaves, then eats every morsel.") | ![Weepinbell](../assets/sprites/weepinbell/back_shiny.png "Weepinbell: If its prey is bigger than its mouth, it slices up the victim with sharp leaves, then eats every morsel.") |
...
| 9 | <span class="tooltip" title="Sharp-edged leaves are launched to slash at the foe. It has a high critical-hit ratio.">Razor Leaf</span> | ![grass](../assets/types/grass.png "Grass"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 55 | 95 | 25 |
...
| 39 | <span class="tooltip" title="The user violently whirls its vines or tentacles to harshly lash the foe. ">Power Whip</span> | ![grass](../assets/types/grass.png "Grass"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 120 | 85 | 10 |
