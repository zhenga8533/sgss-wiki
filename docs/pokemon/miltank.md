...
|-------|-------|------|-------|
| ![Miltank](../assets/sprites/miltank/front.gif "Miltank: If it is around babies, the milk it produces contains much more nutrition than usual.") | ![Miltank](../assets/sprites/miltank/front_shiny.png "Miltank: If it is around babies, the milk it produces contains much more nutrition than usual.") | ![Miltank](../assets/sprites/miltank/back.png "Miltank: If it is around babies, the milk it produces contains much more nutrition than usual.") | ![Miltank](../assets/sprites/miltank/back_shiny.png "Miltank: If it is around babies, the milk it produces contains much more nutrition than usual.") |
...
| 62 | <span class="tooltip" title="The user swings and hits with its strong and heavy fist. It lowers the user’s Speed, however.">Hammer Arm</span> | ![fighting](../assets/types/fighting.png "Fighting"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 100 | 90 | 10 |
