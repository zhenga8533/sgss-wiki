...
|-------|-------|------|-------|
| ![Spoink](../assets/sprites/spoink/front.gif "Spoink: It bounces around on its tail to keep its heart pumping. It carries a pearl from CLAMPERL on its head.") | ![Spoink](../assets/sprites/spoink/front_shiny.png "Spoink: It bounces around on its tail to keep its heart pumping. It carries a pearl from CLAMPERL on its head.") | ![Spoink](../assets/sprites/spoink/back.png "Spoink: It bounces around on its tail to keep its heart pumping. It carries a pearl from CLAMPERL on its head.") | ![Spoink](../assets/sprites/spoink/back_shiny.png "Spoink: It bounces around on its tail to keep its heart pumping. It carries a pearl from CLAMPERL on its head.") |
...
|----------|------------|-----------------|-----------|-------------|------------|
| 1 Special Defense | 255 | 70 | 66 | Fast | <span class="tooltip" title="If held by a Pokémon, it weakens a foe’s supereffective Bug-type attack.">Tanga Berry</span> (5%) |
...
| 26 | <span class="tooltip" title="The user attacks with an odd, unseeable power. It may also make the foe flinch.">Extrasensory</span> | ![psychic](../assets/types/psychic.png "Psychic"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 80 | 100 | 20 |
