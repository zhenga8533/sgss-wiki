...
|-------|-------|------|-------|
| ![Zigzagoon](../assets/sprites/zigzagoon/front.gif "Zigzagoon: It gets interested in everything, which is why it zigs and zags. It is good at finding items.") | ![Zigzagoon](../assets/sprites/zigzagoon/front_shiny.png "Zigzagoon: It gets interested in everything, which is why it zigs and zags. It is good at finding items.") | ![Zigzagoon](../assets/sprites/zigzagoon/back.png "Zigzagoon: It gets interested in everything, which is why it zigs and zags. It is good at finding items.") | ![Zigzagoon](../assets/sprites/zigzagoon/back_shiny.png "Zigzagoon: It gets interested in everything, which is why it zigs and zags. It is good at finding items.") |
...
|----------|------------|-----------------|-----------|-------------|------------|
| 1 Speed | 255 | 50 | 56 | Medium | <span class="tooltip" title="It may be used or held by a Pokémon to heal the user by just 10 HP.">Oran Berry</span> (5%) |
...
| 45 | <span class="tooltip" title="The user flings its held item at the foe to attack. Its power and effects depend on the item.">Fling</span> | ![dark](../assets/types/dark.png "Dark"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | — | 100 | 10 |
