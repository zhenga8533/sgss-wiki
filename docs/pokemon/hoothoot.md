...
**Sacred Gold:** It always stands on one foot. It changes feet so fast, the movement can rarely be seen.

**Storm Silver:** It has a perfect sense of time. Whatever happens, it keeps rhythm by precisely tilting its head in time.
...
|-------|-------|------|-------|
| ![Hoothoot](../assets/sprites/hoothoot/front.gif "Hoothoot: It has a perfect sense of time. Whatever happens, it keeps rhythm by precisely tilting its head in time.") | ![Hoothoot](../assets/sprites/hoothoot/front_shiny.png "Hoothoot: It has a perfect sense of time. Whatever happens, it keeps rhythm by precisely tilting its head in time.") | ![Hoothoot](../assets/sprites/hoothoot/back.png "Hoothoot: It has a perfect sense of time. Whatever happens, it keeps rhythm by precisely tilting its head in time.") | ![Hoothoot](../assets/sprites/hoothoot/back_shiny.png "Hoothoot: It has a perfect sense of time. Whatever happens, it keeps rhythm by precisely tilting its head in time.") |
