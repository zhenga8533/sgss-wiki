...
**Sacred Gold:** The rain clouds it carries let it fire thunderbolts at will. They say that it descended with lightning.

**Storm Silver:** A Pokémon that races across the land while barking a cry that sounds like crashing thunder.
...
|-------|-------|------|-------|
| ![Raikou](../assets/sprites/raikou/front.gif "Raikou: A Pokémon that races across the land while barking a cry that sounds like crashing thunder.") | ![Raikou](../assets/sprites/raikou/front_shiny.png "Raikou: A Pokémon that races across the land while barking a cry that sounds like crashing thunder.") | ![Raikou](../assets/sprites/raikou/back.png "Raikou: A Pokémon that races across the land while barking a cry that sounds like crashing thunder.") | ![Raikou](../assets/sprites/raikou/back_shiny.png "Raikou: A Pokémon that races across the land while barking a cry that sounds like crashing thunder.") |
...
| 50 | <span class="tooltip" title="The user bites with electrified fangs. It may also make the foe flinch or become paralyzed.">Thunder Fang</span> | ![electric](../assets/types/electric.png "Electric"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 65 | 95 | 15 |
