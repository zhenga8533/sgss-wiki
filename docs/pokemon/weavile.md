...
|-------|-------|------|-------|
| ![Weavile](../assets/sprites/weavile/front.gif "Weavile: It lives in snowy regions. It carves patterns in trees with its claws as a signal to others.") | ![Weavile](../assets/sprites/weavile/front_shiny.png "Weavile: It lives in snowy regions. It carves patterns in trees with its claws as a signal to others.") | ![Weavile](../assets/sprites/weavile/back.png "Weavile: It lives in snowy regions. It carves patterns in trees with its claws as a signal to others.") | ![Weavile](../assets/sprites/weavile/back_shiny.png "Weavile: It lives in snowy regions. It carves patterns in trees with its claws as a signal to others.") |

### Female Sprites

| Front | Shiny | Back | Shiny |
|-------|-------|------|-------|
| ![Weavile](../assets/sprites/weavile/front_female.gif "Weavile: It lives in snowy regions. It carves patterns in trees with its claws as a signal to others.") | ![Weavile](../assets/sprites/weavile/front_shiny_female.png "Weavile: It lives in snowy regions. It carves patterns in trees with its claws as a signal to others.") | ![Weavile](../assets/sprites/weavile/back_female.png "Weavile: It lives in snowy regions. It carves patterns in trees with its claws as a signal to others.") | ![Weavile](../assets/sprites/weavile/back_shiny_female.png "Weavile: It lives in snowy regions. It carves patterns in trees with its claws as a signal to others.") |
...
| 51 | <span class="tooltip" title="The user releases a horrible aura imbued with dark thoughts. It may also make the target flinch.">Dark Pulse</span> | ![dark](../assets/types/dark.png "Dark"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 80 | 100 | 15 |
