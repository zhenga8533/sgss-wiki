...
|-------|-------|------|-------|
| ![Gabite](../assets/sprites/gabite/front.gif "Gabite: As it digs to expand its nest, it habitually digs up gems that it then hoards in its nest.") | ![Gabite](../assets/sprites/gabite/front_shiny.png "Gabite: As it digs to expand its nest, it habitually digs up gems that it then hoards in its nest.") | ![Gabite](../assets/sprites/gabite/back.png "Gabite: As it digs to expand its nest, it habitually digs up gems that it then hoards in its nest.") | ![Gabite](../assets/sprites/gabite/back_shiny.png "Gabite: As it digs to expand its nest, it habitually digs up gems that it then hoards in its nest.") |

### Female Sprites

| Front | Shiny | Back | Shiny |
|-------|-------|------|-------|
| ![Gabite](../assets/sprites/gabite/front_female.gif "Gabite: As it digs to expand its nest, it habitually digs up gems that it then hoards in its nest.") | ![Gabite](../assets/sprites/gabite/front_shiny_female.png "Gabite: As it digs to expand its nest, it habitually digs up gems that it then hoards in its nest.") | ![Gabite](../assets/sprites/gabite/back_female.png "Gabite: As it digs to expand its nest, it habitually digs up gems that it then hoards in its nest.") | ![Gabite](../assets/sprites/gabite/back_shiny_female.png "Gabite: As it digs to expand its nest, it habitually digs up gems that it then hoards in its nest.") |
