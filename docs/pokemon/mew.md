...
|-------|-------|------|-------|
| ![Mew](../assets/sprites/mew/front.gif "Mew: Its DNA is said to contain the genetic codes of all Pokémon, so it can use all kinds of techniques.") | ![Mew](../assets/sprites/mew/front_shiny.png "Mew: Its DNA is said to contain the genetic codes of all Pokémon, so it can use all kinds of techniques.") | ![Mew](../assets/sprites/mew/back.png "Mew: Its DNA is said to contain the genetic codes of all Pokémon, so it can use all kinds of techniques.") | ![Mew](../assets/sprites/mew/back_shiny.png "Mew: Its DNA is said to contain the genetic codes of all Pokémon, so it can use all kinds of techniques.") |
...
|------------|---------|--------|--------|-----------|---------|
| #151 | ![psychic](../assets/types/psychic.png "Psychic"){: width="48"} | 0.4 m /<br>1.3 ft | 4.0 kg /<br>8.8 lbs | 1. <span class="tooltip" title="Passes a burn, poison, or paralysis to the foe.">Synchronize</span> | N/A |
...
|----------|------------|-----------------|-----------|-------------|------------|
| 3 Hp | 45 | 100 | 300 | Medium Slow | <span class="tooltip" title="It may be used or held by a Pokémon to recover from any status problem.">Lum Berry</span> (100%) |
