...
|-------|-------|------|-------|
| ![Whiscash](../assets/sprites/whiscash/front.gif "Whiscash: It claims a large swamp to itself. If a foe comes near it, it sets off tremors by thrashing around.") | ![Whiscash](../assets/sprites/whiscash/front_shiny.png "Whiscash: It claims a large swamp to itself. If a foe comes near it, it sets off tremors by thrashing around.") | ![Whiscash](../assets/sprites/whiscash/back.png "Whiscash: It claims a large swamp to itself. If a foe comes near it, it sets off tremors by thrashing around.") | ![Whiscash](../assets/sprites/whiscash/back_shiny.png "Whiscash: It claims a large swamp to itself. If a foe comes near it, it sets off tremors by thrashing around.") |
