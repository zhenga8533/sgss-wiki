...
**Sacred Gold:** It is a well-established symbol of longevity. If its shell has algae on it, that WARTORTLE is very old.

**Storm Silver:** It cleverly controls its furry ears and tail to maintain its balance while swimming.
...
|-------|-------|------|-------|
| ![Wartortle](../assets/sprites/wartortle/front.gif "Wartortle: It cleverly controls its furry ears and tail to maintain its balance while swimming.") | ![Wartortle](../assets/sprites/wartortle/front_shiny.png "Wartortle: It cleverly controls its furry ears and tail to maintain its balance while swimming.") | ![Wartortle](../assets/sprites/wartortle/back.png "Wartortle: It cleverly controls its furry ears and tail to maintain its balance while swimming.") | ![Wartortle](../assets/sprites/wartortle/back_shiny.png "Wartortle: It cleverly controls its furry ears and tail to maintain its balance while swimming.") |
...
|------------|---------|--------|--------|-----------|---------|
| #8 | ![water](../assets/types/water.png "Water"){: width="48"} | 1.0 m /<br>3.3 ft | 22.5 kg /<br>49.6 lbs | 1. <span class="tooltip" title="Powers up Water-type moves in a pinch.">Torrent</span><br>2. <span class="tooltip" title="The Pokémon gradually recovers HP in rain.">Rain Dish</span> | N/A |
