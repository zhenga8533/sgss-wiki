...
|-------|-------|------|-------|
| ![Castform Sunny](../assets/sprites/castform-sunny/front.png "Castform Sunny: This Pokémon can change its cells, taking different forms based on the temperature and humidity.") | ![Castform Sunny](../assets/sprites/castform-sunny/front_shiny.png "Castform Sunny: This Pokémon can change its cells, taking different forms based on the temperature and humidity.") | ![Castform Sunny](../assets/sprites/castform-sunny/back.png "Castform Sunny: This Pokémon can change its cells, taking different forms based on the temperature and humidity.") | ![Castform Sunny](../assets/sprites/castform-sunny/back_shiny.png "Castform Sunny: This Pokémon can change its cells, taking different forms based on the temperature and humidity.") |
