...
|-------|-------|------|-------|
| ![Seviper](../assets/sprites/seviper/front.gif "Seviper: In battle, it uses its bladed tail to counter any ZANGOOSE. It secretes a deadly venom in its tail.") | ![Seviper](../assets/sprites/seviper/front_shiny.png "Seviper: In battle, it uses its bladed tail to counter any ZANGOOSE. It secretes a deadly venom in its tail.") | ![Seviper](../assets/sprites/seviper/back.png "Seviper: In battle, it uses its bladed tail to counter any ZANGOOSE. It secretes a deadly venom in its tail.") | ![Seviper](../assets/sprites/seviper/back_shiny.png "Seviper: In battle, it uses its bladed tail to counter any ZANGOOSE. It secretes a deadly venom in its tail.") |
...
|------------|---------|--------|--------|-----------|---------|
| #336 | ![poison](../assets/types/poison.png "Poison"){: width="48"} | 2.7 m /<br>8.9 ft | 52.5 kg /<br>115.7 lbs | 1. <span class="tooltip" title="The Pokémon may heal its own status problems.">Shed Skin</span><br>2. <span class="tooltip" title="This Pokémon's moves ignore light screen, reflect, and safeguard.">Infiltrator</span> | N/A |
...
| 16 | <span class="tooltip" title="An attack with a high critical-hit ratio. This tail  attack may also  poison the foe.">Poison Tail</span> | ![poison](../assets/types/poison.png "Poison"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 50 | 100 | 25 |
...
| 34 | <span class="tooltip" title="The user bites the foe with toxic fangs. It may also leave the foe badly poisoned. ">Poison Fang</span> | ![poison](../assets/types/poison.png "Poison"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 50 | 100 | 15 |
