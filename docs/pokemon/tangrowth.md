...
|-------|-------|------|-------|
| ![Tangrowth](../assets/sprites/tangrowth/front.gif "Tangrowth: Its vines grow so profusely that, in the warm season, you can’t even see its eyes.") | ![Tangrowth](../assets/sprites/tangrowth/front_shiny.png "Tangrowth: Its vines grow so profusely that, in the warm season, you can’t even see its eyes.") | ![Tangrowth](../assets/sprites/tangrowth/back.png "Tangrowth: Its vines grow so profusely that, in the warm season, you can’t even see its eyes.") | ![Tangrowth](../assets/sprites/tangrowth/back_shiny.png "Tangrowth: Its vines grow so profusely that, in the warm season, you can’t even see its eyes.") |

### Female Sprites

| Front | Shiny | Back | Shiny |
|-------|-------|------|-------|
| ![Tangrowth](../assets/sprites/tangrowth/front_female.gif "Tangrowth: Its vines grow so profusely that, in the warm season, you can’t even see its eyes.") | ![Tangrowth](../assets/sprites/tangrowth/front_shiny_female.png "Tangrowth: Its vines grow so profusely that, in the warm season, you can’t even see its eyes.") | ![Tangrowth](../assets/sprites/tangrowth/back_female.png "Tangrowth: Its vines grow so profusely that, in the warm season, you can’t even see its eyes.") | ![Tangrowth](../assets/sprites/tangrowth/back_shiny_female.png "Tangrowth: Its vines grow so profusely that, in the warm season, you can’t even see its eyes.") |
...
|------------|---------|--------|--------|-----------|---------|
| #465 | ![grass](../assets/types/grass.png "Grass"){: width="48"} | 2.0 m /<br>6.6 ft | 128.6 kg /<br>283.5 lbs | 1. <span class="tooltip" title="Boosts the Pokémon’s Speed in sunshine.">Chlorophyll</span><br>2. <span class="tooltip" title="Prevents problems with status in sunny weather.">Leaf Guard</span><br>3. <span class="tooltip" title="This Pokémon regains 1/3 of its maximum HP when it is switched out for another Pokémon under any circumstances other than having fainted.  This ability does not take effect when a battle ends.">Regenerator</span> | N/A |
...
| 26 | <span class="tooltip" title="A nutrient-draining attack. The user’s HP is restored by half the damage taken by the target.">Mega Drain</span> | ![grass](../assets/types/grass.png "Grass"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 40 | 100 | 15 |
