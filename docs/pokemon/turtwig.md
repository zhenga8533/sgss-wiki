...
|-------|-------|------|-------|
| ![Turtwig](../assets/sprites/turtwig/front.gif "Turtwig: Photosynthesis occurs across its body under the sun. The shell on its back is actually hardened soil.") | ![Turtwig](../assets/sprites/turtwig/front_shiny.png "Turtwig: Photosynthesis occurs across its body under the sun. The shell on its back is actually hardened soil.") | ![Turtwig](../assets/sprites/turtwig/back.png "Turtwig: Photosynthesis occurs across its body under the sun. The shell on its back is actually hardened soil.") | ![Turtwig](../assets/sprites/turtwig/back_shiny.png "Turtwig: Photosynthesis occurs across its body under the sun. The shell on its back is actually hardened soil.") |
