...
|-------|-------|------|-------|
| ![Gastrodon](../assets/sprites/gastrodon/front.gif "Gastrodon: When its natural enemy attacks, it oozes purple fluid and escapes.") | ![Gastrodon](../assets/sprites/gastrodon/front_shiny.png "Gastrodon: When its natural enemy attacks, it oozes purple fluid and escapes.") | ![Gastrodon](../assets/sprites/gastrodon/back.png "Gastrodon: When its natural enemy attacks, it oozes purple fluid and escapes.") | ![Gastrodon](../assets/sprites/gastrodon/back_shiny.png "Gastrodon: When its natural enemy attacks, it oozes purple fluid and escapes.") |

### Gastrodon East Sprites

| Front | Shiny | Back | Shiny |
|-------|-------|------|-------|
| ![Gastrodon East](../assets/sprites/gastrodon-east/front.png "Gastrodon East: When its natural enemy attacks, it oozes purple fluid and escapes.") | ![Gastrodon East](../assets/sprites/gastrodon-east/front_shiny.png "Gastrodon East: When its natural enemy attacks, it oozes purple fluid and escapes.") | ![Gastrodon East](../assets/sprites/gastrodon-east/back.png "Gastrodon East: When its natural enemy attacks, it oozes purple fluid and escapes.") | ![Gastrodon East](../assets/sprites/gastrodon-east/back_shiny.png "Gastrodon East: When its natural enemy attacks, it oozes purple fluid and escapes.") |
...
| 68 | <span class="tooltip" title="The user makes the ground under the foe erupt with power. It may also lower the target’s Sp. Def.">Earth Power</span> | ![ground](../assets/types/ground.png "Ground"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 90 | 100 | 10 |
