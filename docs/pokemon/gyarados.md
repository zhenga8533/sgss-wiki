...
|-------|-------|------|-------|
| ![Gyarados](../assets/sprites/gyarados/front.gif "Gyarados: Once it appears, it goes on a rampage. It remains enraged until it demolishes everything around it.") | ![Gyarados](../assets/sprites/gyarados/front_shiny.png "Gyarados: Once it appears, it goes on a rampage. It remains enraged until it demolishes everything around it.") | ![Gyarados](../assets/sprites/gyarados/back.png "Gyarados: Once it appears, it goes on a rampage. It remains enraged until it demolishes everything around it.") | ![Gyarados](../assets/sprites/gyarados/back_shiny.png "Gyarados: Once it appears, it goes on a rampage. It remains enraged until it demolishes everything around it.") |

### Female Sprites

| Front | Shiny | Back | Shiny |
|-------|-------|------|-------|
| ![Gyarados](../assets/sprites/gyarados/front_female.gif "Gyarados: Once it appears, it goes on a rampage. It remains enraged until it demolishes everything around it.") | ![Gyarados](../assets/sprites/gyarados/front_shiny_female.png "Gyarados: Once it appears, it goes on a rampage. It remains enraged until it demolishes everything around it.") | ![Gyarados](../assets/sprites/gyarados/back_female.png "Gyarados: Once it appears, it goes on a rampage. It remains enraged until it demolishes everything around it.") | ![Gyarados](../assets/sprites/gyarados/back_shiny_female.png "Gyarados: Once it appears, it goes on a rampage. It remains enraged until it demolishes everything around it.") |
...
| 29 | <span class="tooltip" title="The user whips up a vicious tornado to tear at the foe. It may also make the foe flinch.">Twister</span> | ![dragon](../assets/types/dragon.png "Dragon"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 40 | 100 | 20 |
| 32 | <span class="tooltip" title="The user bites with cold-infused fangs. It may also make the foe flinch or freeze. ">Ice Fang</span> | ![ice](../assets/types/ice.png "Ice"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 65 | 95 | 15 |
