...
|-------|-------|------|-------|
| ![Forretress](../assets/sprites/forretress/front.gif "Forretress: It remains immovably rooted to its tree. It scatters pieces of its hard shell to drive its enemies away.") | ![Forretress](../assets/sprites/forretress/front_shiny.png "Forretress: It remains immovably rooted to its tree. It scatters pieces of its hard shell to drive its enemies away.") | ![Forretress](../assets/sprites/forretress/back.png "Forretress: It remains immovably rooted to its tree. It scatters pieces of its hard shell to drive its enemies away.") | ![Forretress](../assets/sprites/forretress/back_shiny.png "Forretress: It remains immovably rooted to its tree. It scatters pieces of its hard shell to drive its enemies away.") |
