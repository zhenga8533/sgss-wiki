...
|-------|-------|------|-------|
| ![Skitty](../assets/sprites/skitty/front.gif "Skitty: It’s adorable when it chases its own tail. It’s difficult to earn its trust.") | ![Skitty](../assets/sprites/skitty/front_shiny.png "Skitty: It’s adorable when it chases its own tail. It’s difficult to earn its trust.") | ![Skitty](../assets/sprites/skitty/back.png "Skitty: It’s adorable when it chases its own tail. It’s difficult to earn its trust.") | ![Skitty](../assets/sprites/skitty/back_shiny.png "Skitty: It’s adorable when it chases its own tail. It’s difficult to earn its trust.") |
...
|----------|------------|-----------------|-----------|-------------|------------|
| 1 Speed | 255 | 70 | 52 | Fast | <span class="tooltip" title="It may be used or held by a Pokémon to restore a move’s PP by 10.">Leppa Berry</span> (5%) |
