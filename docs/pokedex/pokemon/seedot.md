...
??? note "ROM Changes"
    ...
    **Level-up Moves:** `7 moves` → `3 moves`
...
=== ":material-arrow-up-bold: Level-Up"
	...
	| 17 | [Seed Bomb](../../pokedex/moves/seed-bomb.md) | <span class="type-badge" style="background: linear-gradient(135deg, #777777 0%, #777777dd 100%);">???</span> | <span class="category-badge" style="background: linear-gradient(135deg, #C03028 0%, #C03028dd 100%);">Physical</span> | — | — | — |
