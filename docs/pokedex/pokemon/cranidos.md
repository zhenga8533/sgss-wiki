...
??? note "ROM Changes"
    ...
    **Level-up Moves:** `11 moves` → `2 moves`
...
=== ":material-arrow-up-bold: Level-Up"
	...
	| 53 | [Hammer Arm](../../pokedex/moves/hammer-arm.md) | <span class="type-badge" style="background: linear-gradient(135deg, #777777 0%, #777777dd 100%);">???</span> | <span class="category-badge" style="background: linear-gradient(135deg, #C03028 0%, #C03028dd 100%);">Physical</span> | — | — | — |
