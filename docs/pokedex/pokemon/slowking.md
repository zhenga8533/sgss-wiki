...
??? note "ROM Changes"
    ...
    **Evolution Chain:** `slowpoke > slowking: trade (held: kings-rock)` → `slowpoke > slowking: use-item (kings-rock)`

    **Level-up Moves:** `17 moves` → `1 move`
...
=== ":material-arrow-up-bold: Level-Up"
	...
	|:------|:-----|:-----|:---------|:------|:---------|:---|
	| 61 | [Aura Sphere](../../pokedex/moves/aura-sphere.md) | <span class="type-badge" style="background: linear-gradient(135deg, #777777 0%, #777777dd 100%);">???</span> | <span class="category-badge" style="background: linear-gradient(135deg, #6890F0 0%, #6890F0dd 100%);">Special</span> | — | — | — |
