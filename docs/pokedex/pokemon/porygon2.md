...
??? note "ROM Changes"
    ...
    **Evolution Chain:** `porygon > porygon2: trade (held: up-grade)` → `porygon > porygon2: use-item (up-grade)`
...
=== ":material-arrow-up-bold: Level-Up"
	...
	|:------|:-----|:-----|:---------|:------|:---------|:---|
	| 73 | [Gravity](../../pokedex/moves/gravity.md) | <span class="type-badge" style="background: linear-gradient(135deg, #777777 0%, #777777dd 100%);">???</span> | <span class="category-badge" style="background: linear-gradient(135deg, #A8A878 0%, #A8A878dd 100%);">Status</span> | — | — | — |
