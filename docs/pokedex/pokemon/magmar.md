...
??? note "ROM Changes"
    ...
    **Evolution Chain:** `magmar > magmortar: trade (held: magmarizer)` → `magmar > magmortar: use-item (magmarizer)`

    **Level-up Moves:** `13 moves` → `1 move`
...
|:-----|:--------:|:-------:|:-----:|:---------:|:----------:|
| <span style="white-space: nowrap;">![Magmarizer](https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/magmarizer.png){ .item-sprite } [Magmarizer](../../pokedex/items/magmarizer.md)</span> | 50% | 5% | 50% | — | — |
...
=== ":material-arrow-up-bold: Level-Up"
	...
	|:------|:-----|:-----|:---------|:------|:---------|:---|
	| 62 | [Magma Storm](../../pokedex/moves/magma-storm.md) | <span class="type-badge" style="background: linear-gradient(135deg, #777777 0%, #777777dd 100%);">???</span> | <span class="category-badge" style="background: linear-gradient(135deg, #6890F0 0%, #6890F0dd 100%);">Special</span> | — | — | — |
