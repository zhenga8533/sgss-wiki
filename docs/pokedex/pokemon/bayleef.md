...
??? note "ROM Changes"
    ...
    **Level-up Moves:** `16 moves` → `3 moves`
...
=== ":material-arrow-up-bold: Level-Up"
	...
	| 58 | [Leaf Storm](../../pokedex/moves/leaf-storm.md) | <span class="type-badge" style="background: linear-gradient(135deg, #777777 0%, #777777dd 100%);">???</span> | <span class="category-badge" style="background: linear-gradient(135deg, #6890F0 0%, #6890F0dd 100%);">Special</span> | — | — | — |
