...
??? note "ROM Changes"
    ...
    **Level-up Moves:** `15 moves` → `2 moves`

    **TM/HM Compatibility:** `35 moves` → `39 moves (added: stone-edge, rock-slide, strength, rock-smash)`
...
=== ":material-arrow-up-bold: Level-Up"
	...
	|:------|:-----|:-----|:---------|:------|:---------|:---|
	| 42 | [Head Smash](../../pokedex/moves/head-smash.md) | <span class="type-badge" style="background: linear-gradient(135deg, #777777 0%, #777777dd 100%);">???</span> | <span class="category-badge" style="background: linear-gradient(135deg, #C03028 0%, #C03028dd 100%);">Physical</span> | — | — | — |
	| 67 | [Rock Wrecker](../../pokedex/moves/rock-wrecker.md) | <span class="type-badge" style="background: linear-gradient(135deg, #777777 0%, #777777dd 100%);">???</span> | <span class="category-badge" style="background: linear-gradient(135deg, #C03028 0%, #C03028dd 100%);">Physical</span> | — | — | — |
